function [s,x,y] = dspblkstd2(action)
% DSPBLKSTD2 Signal Processing Blockset Standard deviation block helper function.

% Copyright 1995-2003 The MathWorks, Inc.
% $Revision: 1.5.4.2 $ $Date: 2004/04/12 23:07:21 $
