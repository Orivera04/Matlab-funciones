...
% What's new
%
%   New features, bug fixes, and changes in this version
%
%   To display the Release Notes for Version 6.0, type
%   "whatsnew" at the MATLAB command prompt.
%
% Signal Processing Blockset Support Functions
%
...
%
% Signal Processing Blockset Libraries v5.x - v6.x
%
%   dspadpt3      - Adaptive filters
%   dsparch4      - Filter designs
%   dspbuff3      - Buffers
%   dspfactors    - Matrix factorizations
%   dspindex      - Indexing
%   dspinverses   - Matrix inverses
%   dsplp         - Linear prediction
%   dsplibv4      - Main Signal Processing Blockset library for v5.x & v6.x
%   dspmathops    - Math operations
%   dspmlti3      - Multirate filters
%   dspmtrx3      - Matrix operations
%   dspparest3    - Parametric estimation
...
%   dspspect3     - Power spectrum estimation
%   dspsrcs4      - DSP sources
%   dspstat3      - Statistics
%   dspswit3      - Switches and counters
%   dspxfrm3      - Transforms
%   dspwin32      - Windows (WIN32)
%
% Signal Processing Blockset Libraries v4.x
%
%   dspadpt3      - Adaptive filters
...
%   dspinverses   - Matrix inverses
%   dsplp         - Linear prediction
%   dsplibv4      - Main Signal Processing Blockset library for v4.x
%   dspmathops    - Math operations
%   dspmlti3      - Multirate filters
...
%   dspstat3      - Statistics
%   dspswit3      - Switches and counters
%   dspxfrm3      - Transforms (vector-based)
%
% Signal Processing Blockset Libraries v3.x
%
...
%   dsplibv3   - Main Signal Processing Blockset library for v3.x
%   dsplinalg  - Linear algebra library
%   dspmlti2   - Multirate filter blocks
...
%   dspxfrm2   - Vector signal transforms
%
% Signal Processing Blockset Libraries v2.2 and prior
%
...
%   dsplibv2   - Main Signal Processing Blockset library for v2.2
%   dspmlti    - Multirate filter blocks
%   dspmtrx    - Matrix math operations
%   dspsnks    - DSP sinks library
%   dspspect   - Spectral analysis library
%   dspsrcs    - DSP sources library
%   dspstat    - Statistics operations
%   dspswit    - Switches
%   dspvect    - Vector math operations
%   dspxfrm    - Vector signal transforms
%

% Copyright 1995-2003 The MathWorks, Inc.
% Generated from Contents.m_template revision 1.37.4.2 $Date: 2003/12/06 15:22:22 $
