...
%   $Revision: 1.2.2.2 $  $Date: 2004/02/09 07:01:21 $
...
cs=set(ud.pointer.info,'qruns',sscanf(str{val},'%d'));
ud.pointer.info=cs;
set(udh,'userdata',ud);
i_firecb(ud);
return
...
set([ud.cpedt;handle(ud.minedt);handle(ud.maxedt)],'backgroundcolor',bgc,'enable',state);
set(udh,'userdata',ud);