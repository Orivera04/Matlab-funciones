...
- Project/Project Options/Application/Processor/CPU=C167CS and accept the option
  to set all registers to the default values for C167CS and reset execution 
  environment to simulator.
- Project/Project Options/CrossView Pro/ExecutionEnvironment select manufacturer
  = Phytec, then select phyCORE-167; accept the option to set the startup
  registers to the default values for this execution environment
- Project/Project Options/Application/Startup/Syscon, check that X-Bus
  peripherals are already enabled
- Project/Project Options/Application/Startup/XPERCON enable CAN2 Module; be
  sure to check the box 'Include in startup code'
