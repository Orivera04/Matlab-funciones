function retvalue = c2000mem_callback(action)
% C6000DSP_CALLBACK Mask Helper Function for the c2000 memory blocks.
%
% $RCSfile: c2000mem_callback.m,v $
% $Revision: 1.1.6.2 $ $Date: 2004/04/08 20:58:42 $
