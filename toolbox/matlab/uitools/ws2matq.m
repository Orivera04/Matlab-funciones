...
%WS2MATQ Obsolete function.
%   WS2MATQ function is obsolete and may be removed in future versions.
%
%   See also SAVE, LOAD, PERSISTENT

warning('UITools:ObsoleteFunction:ws2matq', 'WS2MATQ function is obsolete.');
...
%  $Revision: 1.21.4.1 $  $Date: 2002/10/24 02:14:47 $
