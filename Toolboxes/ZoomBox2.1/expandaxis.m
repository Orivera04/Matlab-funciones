...
%   by the specified percent.  For example if right were specified as 30 then
%   the upper bound of the x-axis would be increased by 30% of the
...
%   Douglas W. Hull, 2002
%   Version 1.01 Removed errors from help text.
