/*
 *  IIR_DF1_DD_A0SCALE_RT.C - DSP Allpole DF filter runtime helper function.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:45:23 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF1_A0Scale_DD(const real_T           *u,
                                    real_T           *y,
                                    ...
                                    const boolean_T      one_fpf)
{
    ...
    for (k=0; k < numChans; k++) {   /* channel loop */
        ...
        real_T       *filt_mem_num = mem_base + k * numDelays; 
        real_T       *filt_mem_den = filt_mem_num + LenNum; 
