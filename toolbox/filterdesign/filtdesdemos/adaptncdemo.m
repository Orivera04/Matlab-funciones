%% Adaptive Noise Cancelling (ANC) applied to Fetal Electrocardiography.
% This demonstration illustrates the application of adaptive filters to
% noise removal using adaptive noise cancelling.  In adaptive noise
% cancelling, a measured signal d(n) contains two signals:
...
% cancelling:  Principles and applications," Proc. IEEE, vol. 63, no. 12, 
...
% remove the maternal heartbeat signal from the fetal electrocardiogram 
% signal. The canceller needs a reference signal generated from a maternal
% electrocardiogram to perform this task.  Just like the fetal 
% electrocardiogram signal, the maternal electrocardiogram signal will 
% contain some additive broadband noise.
