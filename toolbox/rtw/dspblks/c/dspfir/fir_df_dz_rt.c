/*
 *  FIR_DF_DZ_RT.C - DSP FIR DF filter runtime helper function.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.3 $  $Date: 2004/04/12 23:44:35 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_FIR_DF_DZ(const real_T         *u,
                           creal_T        *y,
