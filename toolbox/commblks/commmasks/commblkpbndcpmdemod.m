function varargout = commblkpbndcpmdemod(block, action, varargin)
% COMMBLKCPMDEMOD Mask dynamic dialog function for CPM demodulator block
% Copyright 1996-2002 The MathWorks, Inc.
%   $Revision: 1.10 $  $Date: 2002/04/14 16:27:44 $
...
case 'init'
    ...
    maskpropupdate('Enabled Baseband Demodulator/CPM Demodulator Baseband','pulseShape');
    maskpropupdate('Enabled Baseband Demodulator/CPM Demodulator Baseband','mappingType');
    maskpropupdate('Enabled Baseband Demodulator/CPM Demodulator Baseband','outputType');
