%Ecuación general de la recta dados dos puntos de la misma
%Dados P(x1,y1) y Q(x1,y2) hallar la ecuación: Ax+By+C=0
...
%Escribir la ecuación en la forma dos_puntos y resolver para y

syms x y 
if x1==y1 & x2==y2
    disp('No hay recta; sólo hay un punto')
elseif y2==y1
...
elseif x2==x1
    disp('la ecuación de larecta es:');
    B=y2-y1;
    C=-B*x1;
