/**********************/  
/* 
 * blms_an_wy_dd_rt.c - Signal Processing Blockset Block LMS adaptive filter run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.1.6.1 $  $Date: 2003/12/06 15:53:28 $ 
 */  
#include "dsp_rt.h"
#include "dspblms_rt.h" 

EXPORT_FCN   void MWDSP_blms_an_wy_DD(   const real_T *inSigU, 
                                const real_T *deSigU, 
                                const real_T  muU,
                                real_T       *inBuff, 
                                real_T       *wgtBuff,
