...
% $Revision: 1.1.6.7 $ $Date: 2004/04/11 00:39:52 $
...
Handles.InputTable      = InputPanel.getDataTable;
...
h = handle( InputPanel.getPlotButton, 'callbackproperties' );
...
if row > 0
  ...
  try
    h   = build( obj, copy(this.up.Experiment.InputData(idx)) );
  catch
