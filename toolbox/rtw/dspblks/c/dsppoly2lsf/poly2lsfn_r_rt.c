/*
 *  poly2lsfn_r_rt.c - Poly2Lsf block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:47:29 $
 */
...

{
    ...
    int_T i;
    for (i = 0; i < P; i++) {
        lsp[i] = (real32_T)(acos((real_T)lsp[i])/DSP_TWO_PI);
    }
    return(nf);
}


/* [EOF] poly2lsfn_r_rt.c */
