function wlan80211a_graphics(s, ax, firstcall, params);
% WLAN80211A_GRAPHICS  Update MATLAB graphics from IEEE 802.11a simulation.
% wlan80211a_graphics(s, ax, firstcall, params) updates axes.
% 
