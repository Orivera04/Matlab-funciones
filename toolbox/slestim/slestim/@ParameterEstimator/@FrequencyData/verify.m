...
% $Revision: 1.1.6.1 $ $Date: 2003/12/22 00:56:52 $
...
if this.getDataLength ~= length(this.Frequency)
  error('Frequency vector length is incompatible with the number of Data samples.')
end
