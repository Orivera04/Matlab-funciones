/* $Revision: 1.4.4.1 $ $Date: 2004/04/08 21:01:46 $ */
/* canac2pcisetupf.c - xPC Target, non-inlined S-function driver for CAN-AC2-PCI from Softing (FIFO mode)  */
...
#define         S_FUNCTION_NAME         canac2pcisetupf
...
#define         CAN1_BUS_ARG                ssGetSFcnParam(S,8)
#define         CAN2_BUS_ARG                ssGetSFcnParam(S,9)
#define         EFDET_ARG                   ssGetSFcnParam(S,10)
#define         ACC1_ARG                    ssGetSFcnParam(S,11)
#define         ACC2_ARG                    ssGetSFcnParam(S,12)
