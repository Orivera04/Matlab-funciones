...
disp(sprintf('          Forward Difference Approximation of the First Derivative'))
...
disp(sprintf('\nThis worksheet demonstrates the use of Matlab to illustrate Forward '))
disp(sprintf('Difference Approximation of the first derivative of continuous functions.')) 
disp(sprintf('Forward Difference Approximation of the first derivative uses a point h'))
disp(sprintf('ahead of the given value of x at which the derivative of f(x) is to be\nfound.'))

disp(sprintf('\n\n************************** Section 1: Input ****************************'))
format short g
disp(sprintf('\nThe following simulation approximates the first derivative of a')) 
disp(sprintf('function using Forward Difference Approximation. \n\nThe user inputs are'))
...
disp(sprintf('Av: Approximate value of the first derivative using Forward Difference \nApproximation'))
...
title({'Approximate Solution of the First Derivative using'; 'Forward Difference Approximation as a Function of Step Size'})
...
disp(sprintf('\nUse Forward Divided Difference method with a step size of 0.25 to find the')) 
...
disp(sprintf('\nTo obtain more accurate values of the first derivative using Forward '))
...
disp(sprintf('in noticeable round-off errors, and hence giving highly inaccurate \nresults.'))
