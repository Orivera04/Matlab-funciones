function [t,x,y] = adams(sys, time, X0, V1_Options, ut, varargin)
%ADAMS Simulink 1.x ADAMS integration algorithm.
%   ADAMS is obsolete and will be eliminated in future versions.  Use SIM
%   instead.  ADAMS is mapped to the Simulink 3 'ode113' algorithm.
%
%   See also SIM.
...
%==============================================================================
% Map V1.3 options to options structure
%==============================================================================

simOptions = compat13('ode113',X0,V1_Options);
