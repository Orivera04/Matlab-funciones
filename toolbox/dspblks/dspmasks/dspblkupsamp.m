function varargout = dspblkupsamp(action,varargin)
% DSPBLKUPSAMP Signal Processing Blockset Upsample block helper function.

% Copyright 1995-2003 The MathWorks, Inc.
% $Revision: 1.5.4.2 $ $Date: 2004/04/12 23:07:35 $
