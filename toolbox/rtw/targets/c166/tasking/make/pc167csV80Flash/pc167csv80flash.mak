...
PROJ    = pc167csv80flash
PROJDIR = d:\aetargets\matlab\toolbox\rtw\targets\c166\tasking\make\pc167csv80flash
...
OPT_LC  = -trap -libfmtiol PRINT("$*.map") -Ms -xmifp -Bhoeufmknladij  -cf "_pc167csv80flash.ilo"
OPT_OPIHEX = -l32
OPT_XVW = -G "." -tcfg "d:\aetargets\matlab\toolbox\rtw\targets\c166\tasking\make\pc167csv80flash\_pc167csv80flash.cfg" -D RS232,COM1:,19200 --single_instance -i --load_application_download=true --enable_flash=true --load_application_signal=true --load_application_program_reset=true --load_application_target_reset=true --load_application_goto_main=true --load_application_break_on_exit=true -a 100 -b 200 -s 26
...
$(PROJ).out : main.obj start.obj _pc167csv80flash.ilo
