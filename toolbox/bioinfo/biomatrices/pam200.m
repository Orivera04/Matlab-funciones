function [matrix, matrixInfo] = pam200
%PAM200 substitution matrix in 1/3 bit units,
...
%
%   [MATRIX,MATRIXINFO] = PAM200 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'PAM200';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 0.507 ;
    matrixInfo.ExpectedScore = -1.23;
