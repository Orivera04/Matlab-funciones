/*
 *  upfir_df_dblbuf_dz_rt.c - FIR Decimation block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:49:26 $
 *
...
EXPORT_FCN void MWDSP_UpFIR_DF_DblBuf_DZ(
    const real_T    *u,
          creal_T   *out,
          real_T    *tap0,
