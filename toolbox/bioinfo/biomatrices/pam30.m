function [matrix, matrixInfo] = pam30
%PAM30 substitution matrix in 1/2 bit units,
...
%
%   [MATRIX,MATRIXINFO] = PAM30 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'PAM30';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 2.57 ;
    matrixInfo.ExpectedScore = -5.06;
    matrixInfo.LowestScore = -17;
