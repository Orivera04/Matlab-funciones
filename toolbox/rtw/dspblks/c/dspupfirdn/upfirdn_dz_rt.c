/*
 *  upfirdn_dz_rt.c - FIR Rate Converter block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:49:34 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_UpFIRDn_DZ(   const real_T  *u,             /* input port*/
