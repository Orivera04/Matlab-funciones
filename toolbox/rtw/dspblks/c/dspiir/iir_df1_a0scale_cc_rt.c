/*
 *  IIR_DF1_CC_A0SCALE_RT.C - DSP Allpole DF filter runtime helper function.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:45:21 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF1_A0Scale_CC(const creal32_T           *u,
                                    creal32_T           *y,
                                    ...
                                    const boolean_T      one_fpf)
{
    ...
    for (k=0; k < numChans; k++) {   /* channel loop */
        ...
        while (i--) {   /* frame loop */
            ...
            psum.re = CMULT_RE(*num,*u);
            psum.im = CMULT_IM(*num,*u); 
