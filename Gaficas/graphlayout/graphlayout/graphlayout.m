...
% Visualize a directed or undirected graph in a Matlab figure window by
% specifying an adjacency matrix and optionally node labels, descriptions,
% colors and the the layout algorithm. The best layout algorithms require
% that graphViz be installed, available free at
% <http://www.graphviz.org/Download..php>.
%
% Requires Matlab version 2008a
% Requires process_options available from
...
% version 1.0 September 30, 2008
    ...
    properties(GetAccess = 'protected',SetAccess = 'protected')
        ...
        selectedFontSize;           % Font size for a selected node
    ...
    methods(Access = 'protected')
        ...
        % Process the inputs and perform error checking    
            ...
            if(str2double(v(1:3)) < 7.6)
               fprintf('\n\n---------------------------------------------------------\n');
               error('Sorry, Graphviz requires Matlab version 2008a, (7.6) or newer.');
            end
            inputs = varargin;
