/*
 *  IIR_DF2_CR_RT.C - DSP IIR DF2 filter runtime helper function.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.4.2.3 $  $Date: 2004/04/12 23:46:02 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF2_CR( const creal32_T         *u,
                       creal32_T               *y,
                       ...
                       const boolean_T         one_fpf)
{
    ...
    for (k=0; k < numChans; k++) {   /* Channel loop */
        ...
        while (i--) {   /* frame loop */
            ...
            real32_T num0 = *num;  /* Cache 0th element to calculate output */
            int_T j;
