/*
 *  IIR_DF2_a0Scale_ZZ_RT.C DSP IIR DF2 filter runtime helper function.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.4.2.3 $  $Date: 2004/04/12 23:46:00 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF2_A0Scale_ZZ (const creal_T           *u,
                               creal_T                *y,
