echo on; clc;
%---------------------------------------------------------------------------
%A6_2   MATLAB script file for implementing Algorithm 6.2
%
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%
% Example 6.3, page 325  Find a numerical approximation for the
...
grid;
hold off;
figure(gcf); pause % Press any key to find the derivative.
...
% Enter the abscissa for differentiation in x0.
%
% Enter the tolerance for the error in  delta.
%
% Enter the tolerance for the relative error in  toler.
