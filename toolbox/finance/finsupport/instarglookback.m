function [OptSpec,Strike,Settle,ExerciseDates,AmericanOpt] = instarglookback(varargin)
%INSTARGLOOKBACK Subroutine for 'Type','Lookback' argument validation.  
%   This function is called at the top of processing routines.
%
%   [OptSpec, Strike, Settle, ExerciseDates, AmericanOpt] = instarglookback(ArgList{:})
%
%   Inputs: 
...
%
%   See also INSTLOOKBACK.

%   Author(s): M. Reyes-Kattar 01-Nov-2002
%   Copyright 1998-2003 The MathWorks, Inc. 
%   $Revision: 1.1.6.1 $  $Date: 2003/08/29 04:45:52 $
...
[FieldList, ClassList, TypeString, SizeList, DefDataList] = instlookback;
