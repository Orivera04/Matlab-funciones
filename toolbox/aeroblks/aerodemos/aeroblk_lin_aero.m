% AEROBLK_LIN_AERO - Linear models from guidance_airframe
%
% See Also :  aeroblk_guidance_airframe and aeroblk_guidance

% Copyright 1990-2002 The MathWorks, Inc.
% $Revision: 1.5.4.1 $ $Date: 2004/04/12 22:59:40 $
...
echo off
aeroblk_guid_dat;
load_system('aeroblk_guidance_airframe');

clc
disp('This script file (aeroblk_lin_aero.m) demonstrates how to trim and')
disp('linearize the non-linear Simulink model aeroblk_guidance_airframe.mdl.')
...
[A,B,C,D]=linmodv5('aeroblk_guidance_airframe',X_trim,U_trim);
