/* $Revision: 1.12.6.1 $ $Date: 2003/11/20 11:57:30 $ */
/* digsadadio.c -- Digital input module for the General Standards PMC-ADADIO */
/* multifunction board. */
/* Copyright 1994-2003 The MathWorks, Inc. */

#define 	S_FUNCTION_LEVEL 	2
#undef 		S_FUNCTION_NAME
#define 	S_FUNCTION_NAME 	digsadadio
...
static void mdlStart(SimStruct *S)
{
    ...
    // This is the digital input block.  Set the digital direction.
    writeLongIO( DIGIO, 0 );
    readLongIO( BCR, temp );
#endif
}
