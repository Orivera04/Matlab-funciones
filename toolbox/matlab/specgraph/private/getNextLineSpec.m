function [l,c,m] = getNextLineSpec(ax,autoColor,autoStyle,firsttime)
%GETNEXTLINESPEC Get next plot linespec
%   [L,C,M] = GETNEXTLINESPEC(AX) gets the next line style, color
%   and marker for plotting from the ColorOrder and LineStyleOrder
%   of axes AX.
%
%   See also PLOT, HOLD

%   [L,C,M] = GETNEXTLINESPEC(AX,COLOR,STYLE,FIRST) gets the next line
