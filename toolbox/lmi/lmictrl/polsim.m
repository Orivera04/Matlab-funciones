%  dx=polsim(t,x,flag,ufun,ptraj,pds,pv,range)
%
%  Called by PDSIMUL: integrate a polytopic PDS with ODE15s

%  Author: P. Gahinet  6/94
%  Copyright 1995-2004 The MathWorks, Inc.
%       $Revision: 1.7.2.3 $

function dx=polsim(t,x,flag,ufun,ptraj,pds,pv,range)
...
% get A(p),B(p),C(p),D(p)
[ap,bp,cp,dp,ep]=ltiss(psinfo(pds,'eval',polydec(pv,pt)));
