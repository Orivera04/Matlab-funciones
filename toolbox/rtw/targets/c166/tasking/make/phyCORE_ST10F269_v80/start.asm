;;
;; C166/ST10 startup code generated by EDE for project st10f269
;;
...
$STDNAMES(reg269.def)		; define SFRs
...
__CSTART	PROC TASK __CSTART_TASK INTNO __CSTART_INUM = 0
	...
	EXTR	#1
	MOV	XPERCON, #0x0007
	BFLDL	SYSCON, #0xFF, #0x0085&0xFF
	BFLDH	SYSCON, #0xFF, #(0x0085>>8)&0xFF
	MOV	ADDRSEL1, #0x0006
	BFLDL	BUSCON1, #0xFF, #0x049F&0xFF
	BFLDH	BUSCON1, #0xF6, #(0x049F>>8)&0xFF
