function varargout = opcguiacdlgfn(varargin)
%OPCGUIACDLGFN OPCTOOL helper function for calling OPC AddClientDlg functions
%   [ErrStr,Y1,Y2,...] = OPCGUIACDLGFN(FunName,X1,X2,...) calls the function
...
% $Revision: 1.1.6.2 $  $Date: 2004/02/09 08:40:13 $
