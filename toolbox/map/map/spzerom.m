function [map,maplegend] = spzerom(latlim,lonlim,scale)

%SPZEROM  Constructs a sparse regular matrix map of all zeros.
%
%  map = SPZEROM(latlim,lonlim,scale) constructs a sparse regular matrix
...
%  be scalar.
%
%  [map,maplegend] = SPZEROM(...) returns the maplegend vector for the
...
%   $Revision: 1.10.4.1 $    $Date: 2003/08/01 18:20:23 $
