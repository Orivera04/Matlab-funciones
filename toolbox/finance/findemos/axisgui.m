...
%AXISGUI Creates a GUI to change axis parameters of the axes referenced 
%        by AxesHandle.
%        
...
% FigureHandle is the handle to the figure created by this function.
%
% Also see axismenu
...
%       $Revision: 1.9 $   $Date: 2002/04/14 21:44:13 $ 
...
if isstr(AxesTag)
   AxesHandle = findobj(gcf,'Tag',AxesTag);
