function [matrix, matrixInfo]  = blosum75
%BLOSUM75 Clustered Scoring Matrix in 1/2 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 75
%   Entropy =   0.9077, Expected Score =  -0.6845
%   Lowest Score = -5, Highest Score = 11
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM75 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM75';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 0.9077;
    matrixInfo.ExpectedScore =  -0.6845;
