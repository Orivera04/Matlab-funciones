function [AllCF, IsTreeDate, AllDates, AllTF, AllInd, PriceObsInd, RateObsInd, DiscFrac ] = hjmtreetime(CFAmounts, CFDates, CFTimes, TreeDates, TreeTimes)
%HJMTREETIME Map instrument cash flows to the time structure of an HJM tree.
%  Subroutine for BONDBYHJM, CFBYHJM, CAPBYHJM, etc.
% 
...
%   $Revision: 1.7 $  $Date: 2002/04/14 16:39:55 $
