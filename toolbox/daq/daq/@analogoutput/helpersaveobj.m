...
%
%    See also DAQ/PRIVATE/SAVE, ANALOGOUTPUT/SAVEOBJ.
%

%    MP 9-23-98
%    Copyright 1998-2003 The MathWorks, Inc.
%    $Revision: 1.8.2.4 $  $Date: 2003/08/29 04:39:49 $
...
% store_info{1} - property values of the Analog Output object
%                (minus the Channel property).
% store_info{2} - property values of the AOChannel objects
