function [c,ceq]=rkt_c(p,N,hf)                                            
% Subroutine for Pb. 10.3.2;                       8/95, 3/24/02
%      
...
for i=1:N, T(i)=(Db(i)+m(i)*a(i))/b(i); m(i+1)=m(i)-T(i)*dt/cf; end	
t=[0:N]/N; tb=[.5:1:N-.5]/N;
ceq=[h(N+1)-hf  m(N+1)-1]; c=-T;  		                           
