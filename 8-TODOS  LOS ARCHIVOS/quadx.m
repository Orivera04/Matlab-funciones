function [Q,fcnt] = quadx(funfcn,a,b,tol,trace,varargin)
...
% For the integration over irregular domain, 
% the region is likely to be too small, then return 0
% to suppress the warning message. $Date: 2005/05/07 $
h=b-a; 
if abs(h)<eps
    Q=0; fcnt=0;return;
end
