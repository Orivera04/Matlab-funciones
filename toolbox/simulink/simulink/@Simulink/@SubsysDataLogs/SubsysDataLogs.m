...
%
%
% Simulink.SubsysDataLogs class defines objects for storing signal data logged
% by Simulink for a subsystem during simulation. A SubsysDataLogs object has a
...
%
%
% Simulink.SubsysDataLogs class defines the following methods for extracting
% data from a subsystem data log object:
%
% * Simulink.SubsysDataLogs.unpack
%
%   Extracts the objects contained by a SubsysDataLogs object.
%
% * Simulink.SubsysDataLogs.whos
%
%   Lists the contents of a SubsysDataLogs object.
%
% * Simulink.SubsysDataLogs.who
%
%   An abbreviated listing of the contents of a SubsysDataLogs object.
%
...
% qualified name of the command, e.g., 'help Simulink.SubsysDataLogs.unpack'
