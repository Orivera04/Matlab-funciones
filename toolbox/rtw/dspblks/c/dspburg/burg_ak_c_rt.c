/* 
 * burg_ak_c_rt - Signal Processing Blockset Burg AR Estimation run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.5.2.3 $  $Date: 2004/04/12 23:42:16 $ 
 */ 

#include "dsp_rt.h"

EXPORT_FCN void MWDSP_Burg_AK_C(const int_T      N,             /* Input array length */
