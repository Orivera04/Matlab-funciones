/* 
   dosbsunidige48.c - xPC Target, non-inlined S-function driver for the
   digital output section of SBS IP-Unidig-E-48
...
#define  S_FUNCTION_NAME  dosbsunidige48
...
#define NUM_REGS             (4)     // number of 16-bit registers     
#define NUM_CHANS            (48)    // number of digital I/O channels  
    ...
    switch (carrierType) {
        ...
        case SBS_PCI40A: {
            ...
            if (pci40a[CNTL2] & AUTO_INT_SET) {
                pci40a[CNTL0] = data & ~(AUTO_ACK | CLR_AUTO);
                sprintf(msg, "No Unidig-E-48 at PCI-40A slot %c, base %03x", 
        ...
        case SBS_FLEX104A: {
            ...
            {
                sprintf(msg, "No Unidig-E-48 at Flex/104A slot %c base 0x%03x", 
