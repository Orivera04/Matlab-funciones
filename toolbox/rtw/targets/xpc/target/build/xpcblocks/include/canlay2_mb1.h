...
/* --  return codes for card services access_mb1 with WINDOWS 3.11              */
#define  INIPC_IB_ERR_WINSYSRES       0xFFFF  /* not enough windows system 
                                                 resources                  */

/* --  return codes for card services access_mb1 with DOS or WINDOWS 3.11       */
...
/* --  return codes for access_mb1 with WIN32 (WINDOWS-NT 4.0 and WINDOWS 95)   */
...
#define  INIPC_IB_ERR_VC_RESOURCEACCESSERROR 0xFE12 /* Resource access_mb1 error*/
#define  INIPC_IB_ERR_VC_PHYSMEMORYOVERRUN 0xFE13 /* invalid phys.mem-access_mb1*/
...
/* -- CANcard return values                                                 */
/* -- return values for access_mb1 with DOS only                                */
...
/* -- return values for access_mb1 with DOS and WINDOWS (WIN16, WIN32)          */
...
PRAEDECL int MIDDECL INIPC_initialize_board_mb1(CANPC_RESSOURCES * ulDPRMemBase);
