/* $Revision: 1.8 $ $Date: 2002/03/25 03:59:27 $ */
/* adcbpcidas.c - xPC Target, non-inlined S-function driver for A/D section of CB PCI-DAS series boards  */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#define         S_FUNCTION_LEVEL        2
#undef          S_FUNCTION_NAME
#define         S_FUNCTION_NAME         adcbpcidas
...
static void     cal_ad(int range,unsigned int base_pci, unsigned int base_status);
#endif
...
static void mdlStart(SimStruct *S)
{
    ...
    cal_ad(range, base_pci, base_status);
...
static void set_gain(unsigned int base_status, unsigned char caldat)
{
    ...
    for (i=0;i<7;i++) {
        j=7-i;
        if ( ((caldat & (1<<j)) >> j) == 0x1) {
            rl32eOutpW((unsigned short)(base_status+0x6),(unsigned short)(0x4200 | 0x8000));
        } else {
            rl32eOutpW((unsigned short)(base_status+0x6),(unsigned short)(0x4200 | 0x0000));
        }
    }
    rl32eOutpW((unsigned short)(base_status+0x6),0x4000);
