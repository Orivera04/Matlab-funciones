/**********************/  
/* 
 * lms_ay_wn_dd_rt.c - Signal Processing Blockset LMS adaptive filter run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.1.6.1 $Date: 2003/12/06 15:57:07 $ 
 */  
#include "dsp_rt.h"
#include "dsplms_rt.h" 

EXPORT_FCN   void MWDSP_lms_ay_wn_DD(   const real_T *inSigU, 
                                const real_T *deSigU, 
                                const real_T  muU,
