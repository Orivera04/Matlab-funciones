...
3. The textbook discusses the following theorem:

    Theorem 1.1  (Limits and Continuous Functions).
    Section 1.1,  Review of Calculus, Page 4

    To run the example for Theorem 1.1 the user needs to use the script file 
    named a1_1.m.  This is accomplished by executing the Matlab command:

    a1_1 

4. The Matlab script in  a1_1.m  includes all the necessary commands.
   The other examples for Chapter 1 are also self contained.
