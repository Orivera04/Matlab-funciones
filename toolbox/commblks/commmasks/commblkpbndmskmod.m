function varargout = commblkpbndmskmod(block, action, varargin)
% COMMBLKPBNDMSKMOD Mask dynamic dialog function for MSK modulator block
% Copyright 1996-2002 The MathWorks, Inc.
%   $Revision: 1.7 $  $Date: 2002/04/14 16:27:40 $
