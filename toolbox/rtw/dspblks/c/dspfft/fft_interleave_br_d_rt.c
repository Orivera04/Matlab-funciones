/*
 * fft_interleave_br_d_rt.c - Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.8.2.3 $  $Date: 2004/04/12 23:43:28 $
 */
    ...
    )
{
     ...
     */
    if (nChans & 0x01) {
        MWDSP_R2BR_Z_OOP(y, (const creal_T *)u, 1, nRows, nRows/2);
    }
}

/* [EOF] fft_interleave_br_d_rt.c */
