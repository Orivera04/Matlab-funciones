% TERMINAL   グラフィックス端末のタイプの設定
% 
% ワーニング：関数 TERMINAL は、将来のリリースで削除されます。
%
% TERMINALは、グラフィックス端末のタイプのメニューを表示し、選択するため
% のプロンプトを表示します。その後、MATLABをコンフィグレーションします。
% 端末のタイプを最初の引数として指定することもできます。ユーザの固有の
% エミュレータと端末に対して必要な端末の設定を、このファイルに追加する
% ことができます。
%
% 正式にサポートされているグラフィックス端末は、つぎの通りです。
%
