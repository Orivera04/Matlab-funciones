function [c,ceq]=climb_c(p,N,Vo,ho,Vf,hf)          
...
for i=1:N,
 ...
 %
 % In-flight equality constraints:
 ceq(i)=mb*Vd(i)-Tmax(i)*cos(alp(i)+ep)+cd*rhor*Vb(i)^2 ...
       +mb*sin(gb(i));
 % In-flight inequality constraints:
 c(i)=-h(i);
end
%
