...
%   $Revision: 1.14.2.8 $  $Date: 2004/01/16 20:01:13 $
...
if (nargout == 0)
   ...
   try
	  ...
	  case 1
          % Ex. out = set(obj);
          if (length(obj) > 1)
              error('insturment:set:scalarHandle', 'Only one object may be passed to SET for information about possible property values.');
          end
