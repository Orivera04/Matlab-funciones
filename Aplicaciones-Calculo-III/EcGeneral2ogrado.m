%Ecuación General de 2o. grado: Ax^2+Bxy+Cy^2+Dx+Ey+F=0
%Introducir los coeficientes de la ecuación
...
F=input('Dar coeficiente F: ');
 if B==0 & D==0 & E==0 & F<0 & A>0 & C>0
     disp('La ecuación representa una elipse')
 elseif (B==0 & D==0 & E==0 & A>0 & C<0 & F<0)|(B==0 & D==0 & E==0 & A<0 & C>0 & F<0)
     disp('La ecuación representa una hipérbola')
 elseif (A==0&B==0&E==0&C>0&abs(D)>0)|(B==0&C==0&D==0&A>0&abs(E)>0)
     disp('La ecuación representa una parábola')
 elseif A>0&C>0&B==0&D==0&E==0&F==0
     disp('La ecuación representa un punto: el (0,0)')
 elseif (A>0&C<0&B==0&D==0&E==0&F==0)|(A<0&C>0&B==0&D==0&E==0&F==0)
     disp('La ecuación representa un par de rectas que se cortan')
 elseif (C>0&F<0&A==0&B==0&D==0&E==0)|(A>0&F<0&C==0&B==0&D==0&E==0)
     disp('La ecuación representa un par de rectas paralelas')
 elseif (C>0&A==0&B==0&D==0&E==0&F==0)|(A>0&C==0&B==0&D==0&E==0&F==0)
     disp('La ecuación representa una recta')
