function symbolInfo = ec_get_datasym(package,classIndex,csc,memorySection)
%EC_GET_DATASYM 

%   Steve Toeppe
%   Copyright 2003-2004 The MathWorks, Inc.
%   $Revision: 1.1.6.4 $  $Date: 2004/04/15 00:26:43 $
...
if isempty(pIndex) == 0
    ...
    if isempty(cscIndex) == 0
        matches = strcmp(mpt_symbol_mapping.package{pIndex}.memorySectionList,memorySection);
        ...
        symbolInfo = default_mapping;
    end
else
symbolInfo = default_mapping;
end

function symbolInfo = default_mapping
