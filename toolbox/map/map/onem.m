function [map,maplegend] = onem(latlim,lonlim,scale)

%ONEM  Constructs a regular matrix map of all ones.
%
%  map = ONEM(latlim,lonlim,scale) constructs a regular matrix
%  map of all 1's.  The inputs are the latitude and longitude limits
...
%  be scalar.
%
%  [map,maplegend] = ONEM(...) returns the maplegend vector for the
...
%   $Revision: 1.10.4.1 $    $Date: 2003/08/01 18:17:28 $
