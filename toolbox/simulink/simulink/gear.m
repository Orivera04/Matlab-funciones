function [t,x,y] = gear(sys, time, X0, V1_Options, ut, varargin)
%GEAR Simulink 1.x GEAR integration algorithm.
%   GEAR is obsolete and will be eliminated in future versions.  Use SIM
%   instead.  GEAR is mapped to the Simulink 3 'ode15s' algorithm.
%
%   See also SIM.
...
simOptions = compat13('ode15s',X0,V1_Options);
