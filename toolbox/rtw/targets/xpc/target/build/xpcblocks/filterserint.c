...
/* $Revision: 1.2 $ $Date: 2003/01/22 20:18:18 $ */
...
#define         S_FUNCTION_NAME         filterserint
...
#define VALUE_ARG               ssGetSFcnParam(S,1)
...
//if( value == 1 && (ivalue & 0xff == 1) )
//    printf("filter: port %d, value %d, ivalue %x, max %d, out %d (%x)\n", port, value, ivalue, max, OPtr[0], OPtr );
#endif
