function [matrix, matrixInfo]  = blosum60
%BLOSUM60 Clustered Scoring Matrix in 1/2 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 60
%   Entropy =   0.6603, Expected Score =  -0.4917
%   Lowest Score = -4, Highest Score = 10
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM60 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM60';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 0.6603;
    matrixInfo.ExpectedScore =  -0.4917;
