function [matrix, matrixInfo]  = blosum55
%BLOSUM55 Clustered Scoring Matrix in 1/3 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 55
%   Entropy =   0.5637, Expected Score =  -0.4179
%   Lowest Score = -5, Highest Score = 15
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM55 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM55';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 0.5637;
    matrixInfo.ExpectedScore =  -0.4179;
