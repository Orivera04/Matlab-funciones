function [reset, initValue, baseDec, maskDisplay, maskDescription] = mdadsmm16at(phase, channel, reset, initValue, sampleTime, base);

% Mask Initialization function for Diamond Systems MM D/A driver blocks
% Copyright 1996-2002 The MathWorks, Inc.
%   $Revision: 1.1 $  $Date: 2002/12/09 22:34:09 $

    vendorName   = 'Diamond';
    deviceName   = 'MM-16-AT';
    description  = 'Analog Output';
    maskType     = 'dadiamondmm16at';
    resolution   = 4096;
    maxChan      = 4;
