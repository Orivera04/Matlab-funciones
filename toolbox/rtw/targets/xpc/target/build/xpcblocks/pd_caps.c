...
//
/*int  _PdGetCapsPtrA(HANDLE hAdapter, DWORD* pdwError, PDAQ_Information* pDaqInf)
{
                               ...
                               )
{
    ...
    strcpy(pAdInfo->lpSerialNum, pd_board[board].Eeprom.u.Header.SerialNumber);
    ...
    if ((pAdInfo->atType & atMF))
    {
      ...
      pAdInfo->SSI[AnalogIn].dwFifoSize = pd_board[board].Eeprom.u.Header.ADCFifoSize * 1024;
      pAdInfo->SSI[AnalogIn].dwChListSize = pd_board[board].Eeprom.u.Header.CLFifoSize * 256;
