function [tableData,flags,tableObjs] = report_tableexec_block(blockEntry,currTableCnt)
% TABLEEXEC_BLOCK - Synthesize look-up table coverage data
...
% Copyright 2003 The MathWorks, Inc.
    ...
    [tableObjs,localIdx,localCnt,totalIdx,totalCnt] = cv('MetricGet',blockEntry.cvId, ...
