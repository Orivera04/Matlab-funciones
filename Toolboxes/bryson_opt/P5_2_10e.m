% Script p5_2_10e.m; cart with inv. pendulum using TLQS; (M,m)=(cart,
% pendulum) mass, l=pendulum length, u=force on cart, y=displ. of cart,
% th=angle pendulum; x=[y v th q]'; y in l, t in sqrt[Ml/(M+m)g]/2*pi,
% u in (M+m)g, ep=m/(m+M); FAILS for tf > 18;             2/95, 3/31/02
%
flg=1; 
...
psi=[1 0 0 0]'; [x,u,t]=tlqs(A,B,Q,N,R,tf,x0,Mf,Qf,psi,Ns); 
