...
%   $Revision: 1.30.4.3 $ $Date: 2004/04/06 01:04:51 $
...
if nargin == 3,
    resp=callSwitchyard(cc.ccsversion,[7 cc.boardnum cc.procnum dtimeout cc.eventwaitms],address,datatype);
elseif nargin >= 4,
    resp=callSwitchyard(cc.ccsversion,[7 cc.boardnum cc.procnum dtimeout cc.eventwaitms],address,datatype,count);
end
