...
%       Make set work with right way, without requiring output of object
...
% name.  Any ideas?
%
% There are two additional read-only properties of the dragndrop object:
% Parent:        The handle to the parent fiure of the dragndrop object
% DropLocations: The locations (in figure units) of the drop targets.
%
%
...
dd.DropLocations = [];      %Depends on DropHandles.  Defined in set. 
%size: length(DropHandles) x 2 x 5
%dim1: list of drop targets
%dim2: x values, y values
%dim3: 5 points to define a closed rectangle
