...
%
%    Training occurs according to the TRAINB's training parameters,
...
% $Revision: 1.6 $  $Date: 2002/04/14 21:37:56 $
...
for epoch=0:epochs
  ...
  if (doTest)
    tr.tperf(epochPlus1) = feval(simfuncname,net,TV.Pd,TV.Ai,TV.Tl,TV.Q,TV.TS);
  end
  ...
  % Gradient
  if (needGradient)
    [gB,gIW,gLW,gA] = feval(bpfuncname,net,Pd,Zb,Zi,Zl,N,Ac,El,Q,TS);
  end
