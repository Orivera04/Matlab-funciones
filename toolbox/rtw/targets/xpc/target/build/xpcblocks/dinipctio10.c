/* $Revision: 1.4 $ $Date: 2002/03/25 04:07:02 $*/
/* dinipctio10.c - xPC Target, non-inlined S-function driver for digital input section of NI PC-TIO-10 board */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME 		dinipctio10
...
static void mdlOutputs(real_T *y, const real_T *x, const real_T *u, SimStruct *S, int_T tid)
{
    ...
    input=rl32eInpB((unsigned short)(base_addr+port));
