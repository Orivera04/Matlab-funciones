/* $Revision: 1.2.2.2 $ */
/*
 *  IIR_DF2T_A0SCALE_ZZ_RT.C - DSP filter block runtime helper function
 *
...
EXPORT_FCN void MWDSP_IIR_DF2T_A0Scale_ZZ(const creal_T         *u,
                               creal_T               *y,
