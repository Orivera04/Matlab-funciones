function varargout = commblkcpfskmod(block, action, varargin)
% COMMBLKCPFSKMOD Mask dynamic dialog function for CPFSK modulator block
...
%        set_param([block '/CPM Modulator Baseband'],'inputType',get_param(block, 'inputType'));
    end
