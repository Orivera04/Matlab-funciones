...
% release)
% Additional syntax not already described in zoom m-help
%
...
if strcmp(state,'on')    
    ...
    localUIUpdateContextMenuLabel(appdata,zoom_direction);
...
if strcmp(get(hFigure,'CurrentModifier'),'alt')
...
%-----------------------------------------------% 
function [hui] = localUICreateContextMenu(hZoom)
% Create context menu
...
%-----------------------------------------------%
function localUIUpdateContextMenuLabel(appdata,zoom_direction);

h = findobj(appdata.uicontextmenu,'Tag','ZoomInOut');
