function [y,e,S] = adaptse(x,d,S)
%ADAPTSE Sign-error FIR adaptive filter.
%   Y = ADAPTSE(X,D,S) applies a sign-error FIR adaptive filter
...
%
%   [Y,E]   = ADAPTSE(...) also returns the prediction error E.
%
%   [Y,E,S] = ADAPTSE(...) returns the updated structure S.
%
%   ADAPTSE can be called for a block of data, when X and D are vectors,
...
%   end
% 
%   In lieu of assigning the structure fields manually, the INITSE function can be 
...
%
%   See also INITSE, ADAPTSD, ADAPTSS, ADAPTLMS, ADAPTNLMS, and ADAPTRLS.
...
%   $Revision: 1.7 $  $Date: 2002/11/21 16:14:34 $

warning(generatemsgid('obsolete'), ...
        ['ADAPTSE is obsolete and will be removed in future versions of \n',...
            'Filter Design Toolbox. Type "help adaptfilt/se" and "help adaptfilt/filter"\n',...
...
[y,e,S] = adaptfirfilt(x,d,S,@updatese);
