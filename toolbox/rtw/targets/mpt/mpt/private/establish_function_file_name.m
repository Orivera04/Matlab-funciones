function optionFcnFile = establish_function_file_name(path,uniqueName)
...
%   $Revision: 1.8 $  $Date: 2002/07/17 12:54:13 $

optionFcnFile.subSysName = get_param(path,'Name');
optionFcnFile.subSysName = fliplr(deblank(fliplr(deblank(optionFcnFile.subSysName))));
...
optionFcnFile.RTWFcnName = fliplr(deblank(fliplr(deblank(optionFcnFile.RTWFcnName))));

optionFcnFile.RTWFileNameOpts = get_param(path,'RTWFileNameOpts');
optionFcnFile.RTWFileName = get_param(path,'RTWFileName');
optionFcnFile.RTWFileName = fliplr(deblank(fliplr(deblank(optionFcnFile.RTWFileName))));
