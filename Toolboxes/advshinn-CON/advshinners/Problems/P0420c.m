function [ret,x0,str]=P0420C(t,x,u,flag);
%P0420C is the M-file description of the SIMULINK system named P0420C.
%       The block-diagram can be displayed by typing: P0420C.
%
%       SYS=P0420C(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%       Setting FLAG=1 causes P0420C to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%       Calling P0420C with a FLAG of zero:
%       [SIZES]=P0420C([],[],[],0),  returns a vector, SIZES, which
