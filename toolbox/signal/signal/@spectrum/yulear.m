...
%YULEAR   Yule-Walker spectral estimation.
%   H = SPECTRUM.YULEAR instantiates a Yule-Walker (yulear) spectrum object.
%
%   H = SPECTRUM.YULEAR(ORDER) sets the order property to ORDER.
%
%   H = SPECTRUM.YULEAR(ORDER,FFTLENGTH) sets the mode of specifying the
...
% 
%   See also SPECTRUM/PSD, SPECTRUM/BURG, SPECTRUM/COV, SPECTRUM/MCOV,
%   SPECTRUM/MTM, SPECTRUM/WELCH, SPECTRUM/PERIODOGRAM,
%   SPECTRUM/EIGENVECTOR, SPECTRUM/MUSIC.

%   Author(s): P. Pacheco
%   Copyright 1988-2004 The MathWorks, Inc.
%   $Revision: 1.1.6.5 $  $Date: 2004/04/13 00:18:35 $

% Help for constructing a yulear object.
