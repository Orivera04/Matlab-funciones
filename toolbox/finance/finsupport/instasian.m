function varargout = instasian(varargin)
%INSTASIAN Constructor for the 'Type','Asian' instrument.
%
...
%
%   To add 'asian' instruments to an instrument variable:
%     InstSet = instasian(InstSetOld, OptSpec, ... )
%
%   To list field meta-data for the 'asian' instrument:
...
%     Type "[FieldList, ClassList] = instasian" to see the classes.  Dates
...
%   $Revision: 1.1.6.1 $  $Date: 2003/08/29 04:45:54 $
...
FieldInfo = {
  ...
  'AvgType'         , 'char' , [Inf, Inf] ,     ['arithmetic']
  'AvgPrice'        , 'dble' , [1, 1] ,         [NaN]
  'AvgDate'         , 'date' , [1, 1] ,         [NaN]};
