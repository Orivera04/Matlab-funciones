function d2r=DMmathieu_Q3(kf,m,Q,x,varargin)
%
%     ==============================================================
...
%%for kr=1:nr
  for kr=1:lq  
   ...
   by2(k,kr)=besselk(fix(k)-1,u2(kr));
%%bessel function relationship
%%dj(k+1)=bj(fix(k)-1+1)-fix(k)./x.*bj(fix(k)+1);
   %%dj1(0+1,kr)=-bj1(1+1,kr);
   %%dj2(0+1,kr)=-bj2(1+1,kr);
   %%dy2(0+1,kr)=-by2(1+1,kr);
      %%for kmd=1:km+1
          %%dj1(kmd+1,kr)=bj1(fix(kmd),kr)-fix(kmd+1)./u1(kr).*bj1(fix(kmd)+1,kr);
          %%dj2(kmd+1,kr)=bj2(fix(kmd),kr)-fix(kmd+1)./u2(kr).*bj2(fix(kmd)+1,kr);
          %%dy2(kmd+1,kr)=by2(fix(kmd),kr)-fix(kmd+1)./u2(kr).*by2(fix(kmd)+1,kr);
     %% end
  dj1(k,kr)=dbesseli(fix(k)-1,u1(kr));
  dy2(k,kr)=dbesselk(fix(k)-1,u2(kr));
end;
...
%%d1r(kr)=d1r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*bj1(fix(k)-1+1,kr).*dj2(fix(k)-1+1,kr)-c1.*dj1(fix(k)-1+1,kr).*bj2(fix(k)-1+1,kr));
%%d1r(kr)=d1r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*bj1(fix(k),kr).*dj2(fix(k),kr)-c1.*dj1(fix(k),kr).*bj2(fix(k),kr));
...
%%d1r(kr)=d1r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*(bj1(fix(k)-1+1,kr).*dj2(fix(k)+1,kr)+(-1).^fix(kd).*bj1(fix(k)+1,kr).*dj2(fix(k)-1+1,kr))-c1.*(dj1(fix(k)-1+1,kr).*bj2(fix(k)+1,kr)+(-1).^fix(kd).*dj1(fix(k)+1,kr).*bj2(fix(k)-1+1,kr)));
%%d1r(kr)=d1r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*(bj1(fix(k),kr).*dj2(fix(k)+1,kr)+(-1).^fix(kd).*bj1(fix(k)+1,kr).*dj2(fix(k),kr))-c1.*(dj1(fix(k),kr).*bj2(fix(k)+1,kr)+(-1).^fix(kd).*dj1(fix(k)+1,kr).*bj2(fix(k),kr)))
...
%%d1r(kr)=d1r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*(bj1(fix(k)-1+1,kr).*dj2(fix(k)+1+1,kr)-bj1(fix(k)+1+1,kr).*dj2(fix(k)-1+1,kr))-c1.*(dj1(fix(k)-1+1,kr).*bj2(fix(k)+1+1,kr)-dj1(fix(k)+1+1,kr).*bj2(fix(k)-1+1,kr)));
...
%%for k=1 : km;
%%if(kd==1);
%%f2r(kr)=f2r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*bj1(fix(k)-1+1,kr).*by2(fix(k)-1+1,kr);
%%elseif(kd==2 | kd==3);
%%f2r(kr)=f2r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(bj1(fix(k)-1+1,kr).*by2(fix(k)+1,kr)+(-1).^fix(kd).*bj1(fix(k)+1,kr).*by2(fix(k)-1+1,kr));
%%else;
%%f2r(kr)=f2r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(bj1(fix(k)-1+1,kr).*by2(fix(k)+1+1,kr)-bj1(fix(k)+1+1,kr).*by2(fix(k)-1+1,kr));
%%end;
 ...
 for kr=1:lq;
  for k=1 : km;
    if(kd==1);
      ...
      %%d2r(kr)=d2r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*bj1(fix(k)-1+1,kr).*dy2(fix(k)-1+1,kr)-c1.*dj1(fix(k)-1+1,kr).*by2(fix(k)-1+1,kr));
       d2r(kr)=d2r(kr)+i.*(-1).^(fix(ic)+1).*fg(kr,fix(k)).*(c2.*bj1(fix(k)-1+1,kr).*dy2(fix(k)-1+1,kr)-c1.*dj1(fix(k)-1+1,kr).*by2(fix(k)-1+1,kr));
       ...
       elseif(kd==2 | kd==3);
         ...
         %% d2r(kr)=d2r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*(bj1(fix(k)-1+1,kr).*dy2(fix(k)+1,kr)+(-1).^fix(kd).*bj1(fix(k)+1,kr).*dy2(fix(k)-1+1,kr))-c1.*(dj1(fix(k)-1+1,kr).*by2(fix(k)+1,kr)+(-1).^fix(kd).*dj1(fix(k)+1,kr).*by2(fix(k)-1+1,kr)));
           d2r(kr)=d2r(kr)+(-1).^(fix(ic)+1).*fg(kr,fix(k)).*(c2.*(bj1(fix(k)-1+1,kr).*dy2(fix(k)+1,kr)+(-1).^fix(kd).*bj1(fix(k)+1,kr).*dy2(fix(k)-1+1,kr))-c1.*(dj1(fix(k)-1+1,kr).*by2(fix(k)+1,kr)+(-1).^fix(kd).*dj1(fix(k)+1,kr).*by2(fix(k)-1+1,kr)));
              ...
              %% d2r=d2r+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*(bj1(fix(k)-1+1).*dy2(fix(k)+1+1)-bj1(fix(k)+1+1).*dy2(fix(k)-1+1))-c1.*(dj1(fix(k)-1+1).*by2(fix(k)+1+1)-dj1(fix(k)+1+1).*by2(fix(k)-1+1)));
               %%d2r(kr)=d2r(kr)+(-1).^(fix(ic)+fix(k)).*fg(fix(k)).*(c2.*(bj1(fix(k)-1+1,kr).*dy2(fix(k)+1+1,kr)-bj1(fix(k)+1+1,kr).*dy2(fix(k)-1+1,kr))-c1.*(dj1(fix(k)-1+1,kr).*by2(fix(k)+1+1,kr)-dj1(fix(k)+1+1,kr).*by2(fix(k)-1+1,kr)));
               d2r(kr)=d2r(kr)+i.*(-1).^(fix(ic)).*fg(kr,fix(k)).*(c2.*(bj1(fix(k)-1+1,kr).*dy2(fix(k)+1+1,kr)-bj1(fix(k)+1+1,kr).*dy2(fix(k)-1+1,kr))-c1.*(dj1(fix(k)-1+1,kr).*by2(fix(k)+1+1,kr)-dj1(fix(k)+1+1,kr).*by2(fix(k)-1+1,kr)));
...
d2r(kr)=d2r(kr).*2.*sqrt(q(kr))./(pi.*fg(kr,1));
 end;
