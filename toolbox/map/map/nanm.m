function [map,maplegend] = nanm(latlim,lonlim,scale)

%NANM  Constructs a regular matrix map of all NaNs.
%
%  map = NANM(latlim,lonlim,scale) constructs a regular matrix
%  map of all NaNs.  The inputs are the latitude and longitude limits
...
%  be scalar.
%
%  [map,maplegend] = NANM(...) returns the maplegend vector for the
...
%   $Revision: 1.10.4.1 $    $Date: 2003/08/01 18:17:18 $
