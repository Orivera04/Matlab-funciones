function [N, ff, aa, wts] = firpmord(fcuts, mags, devs, fsamp, cellflag)
...
%   ripples allowable  for each band.  DEV must have the same length as A.
%
...
%   $Revision: 1.1.6.2 $  $Date: 2004/04/13 00:17:56 $
