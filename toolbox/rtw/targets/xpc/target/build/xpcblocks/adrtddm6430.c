/* $Revision: 1.5 $ $Date: 2002/03/25 04:00:04 $ */
/* adrtddm6430.c - xPC Target, non-inlined S-function driver for analog input section of Real Time Devices DM6430 board */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME adrtddm6430
...
static void mdlInitializeConditions(real_T *x0, SimStruct *S)
{
	...
	if (!RTD_DM6430_init) {
  	...
  	SetBurstTrigger6430(0);              // Set Burst Trigger = Softwar.
  	...
  	LoadADTable6430( num_channels,ADTable); // Load AD Table.
