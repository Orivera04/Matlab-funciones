% Script p8_5_22a.m; max final altitude, glider w. parabolic lift-
% drag polar; s=[V ga h]'; u=alpha; h in l, V in sqrt(g*l), T=.2,
% alm=1/12, l=2m/(rho*S*Cla); eta=1/2; V0=Vf=4, ga0=gaf=0; 8/11/02
%
N=30; tf=30; load p8_5_22a;   
name='gld0'; s0=[4 0 0]'; tol=1e-3; mxit=0; c=180/pi; 
[t,al,s,K,Hu,Huu]=fop0n2(name,tu,al0,s0,tf,tol,mxit);
V=s(:,1); ga=s(:,2); h=s(:,3); es=2.614^2/2; N1=length(t);
%
