function [matrix, matrixInfo]  = blosum100
%BLOSUM100 Clustered Scoring Matrix in 1/3 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 100
%   Entropy =   1.4516, Expected Score =  -1.0948
%   Lowest Score = -10, Highest Score = 17
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM100 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM100';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 1.4516;
    matrixInfo.ExpectedScore = -1.0948;
