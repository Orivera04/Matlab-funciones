...
PRAEDECL int MIDDECL INIPC_initialize_board(CANPC_RESSOURCES * ulDPRMemBase, int pci_slot);
...
PRAEDECL int MIDDECL CANPC_get_version(int  * sw_version, 
                                       int  * fw_version,
                                       int  * hw_version,
                                       int  * license,
                                       int  * can_chip_type);
...
PRAEDECL int MIDDECL CANPC_get_serial_number(unsigned long  * ser_number);
...
PRAEDECL int MIDDECL CANPC_read_ac(param_struct  * param);
...
PRAEDECL int MIDDECL CANPC_get_trigger (int  * level);

PRAEDECL int MIDDECL CANPC_get_trigger2(int  * level);
...
/* +--- CANPC_get_time               ---------------------------------------*/
PRAEDECL int MIDDECL CANPC_get_time(unsigned long  * time);
...
PRAEDECL int MIDDECL CANPC_set_path(char  * path);
