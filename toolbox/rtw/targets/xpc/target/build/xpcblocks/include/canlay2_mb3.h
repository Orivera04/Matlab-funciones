...
#define  CANPC_BOARD_NOT_INITIALIZED     -99  /* board not initialized:
                                                 INIPC_initialize_board_mb3(.) 
                                                 was not yet called, or a 
                                                 INIPC_close_board_mb3 was done */

/* ---- INIPC_initialize_board_mb3   -------------------------------------------*/

/* -- CANcard return values                                                 */
/* --  return codes for card services access_mb3 with WINDOWS 3.11              */
#define  INIPC_IB_ERR_WINSYSRES       0xFFFF  /* not enough windows system 
                                                 resources                  */

/* --  return codes for card services access_mb3 with DOS or WINDOWS 3.11       */
...
/* --  return codes for access_mb3 with WIN32 (WINDOWS-NT 4.0 and WINDOWS 95)   */
...
#define  INIPC_IB_ERR_VC_RESOURCEACCESSERROR 0xFE12 /* Resource access_mb3 error*/
#define  INIPC_IB_ERR_VC_PHYSMEMORYOVERRUN 0xFE13 /* invalid phys.mem-access_mb3*/
...
/* +--- CANPC_reset_board_mb3        -------------------------------------------*/
/* -- CANcard return values                                                 */
/* -- return values for access_mb3 with DOS only                                */
...
/* -- return values for access_mb3 with DOS and WINDOWS (WIN16, WIN32)          */
...
PRAEDECL int MIDDECL INIPC_initialize_board_mb3(CANPC_RESSOURCES * ulDPRMemBase);



PRAEDECL int MIDDECL CANPC_reset_board_mb3(void);

/* +--- CANPC_reset_chip_mb3         -------------------------------------------*/
PRAEDECL int MIDDECL CANPC_reset_chip_mb3(void);

/* +--- CANPC_initialize_chip_mb3(2) -------------------------------------------*/
#define  CANPC_IC_PARAM_ERR               -1  /* Parameter error            */
PRAEDECL int MIDDECL CANPC_initialize_chip_mb3 (int presc,
                               int sjw,
                               int tseg1,
                               int tseg2,
                               int sam);

PRAEDECL int MIDDECL CANPC_initialize_chip2_mb3(int presc,
                               int sjw,
                               int tseg1,
                               int tseg2,
                               int sam);

/* +--- CANPC_set_mode_mb3(2)        -------------------------------------------*/
PRAEDECL int MIDDECL CANPC_set_mode_mb3 (int SleepMode,
                        int SpeedMode);

PRAEDECL int MIDDECL CANPC_set_mode2_mb3(int SleepMode,
                        int SpeedMode);

/* +--- CANPC_set_acceptance_mb3(2)  -------------------------------------------*/
PRAEDECL int MIDDECL CANPC_set_acceptance_mb3 (unsigned int AccCodeStd,
                              unsigned int AccMaskStd,
                              unsigned long AccCodeXtd,
                              unsigned long AccMaskXtd);

PRAEDECL int MIDDECL CANPC_set_acceptance2_mb3(unsigned int AccCodeStd,
                              unsigned int AccMaskStd,
                              unsigned long AccCodeXtd,
                              unsigned long AccMaskXtd);

/* +--- CANPC_set_output_control_mb3(2)  ---------------------------------------*/
PRAEDECL int MIDDECL CANPC_set_output_control_mb3 (int OutputControl);

PRAEDECL int MIDDECL CANPC_set_output_control2_mb3(int OutputControl);

/* +--- CANPC_initialize_interface_mb3   ---------------------------------------*/
...
PRAEDECL int MIDDECL CANPC_initialize_interface_mb3(int ReceiveFifoEnable,
                                   int ReceivePollAll,
...
PRAEDECL int MIDDECL CANPC_define_object_mb3 (unsigned long Handle,
                             int  * ObjectNumber,
                             int Type,
...
PRAEDECL int MIDDECL CANPC_define_object2_mb3(unsigned long Handle,
                             int  * ObjectNumber,
                             int Type,
                             int ReceiveIntEnable,
                             int AutoRemoteEnable,
...
PRAEDECL int MIDDECL CANPC_define_cyclic_mb3 (int ObjectNumber,
                             unsigned int Rate,
                             unsigned int Cycles);

PRAEDECL int MIDDECL CANPC_define_cyclic2_mb3(int ObjectNumber,
                             unsigned int Rate,
                             unsigned int Cycles);

/* +--- CANPC_enable_fifo_mb3            ---------------------------------------*/

PRAEDECL int MIDDECL CANPC_enable_fifo_mb3(void);

/* +--- CANPC_optimize_rcv_speed_mb3     ---------------------------------------*/
/* this function has no effect on the CANcard                               */
#define  CANPC_ORS_PARAM_ERR              -1  /* Parameter error            */

PRAEDECL int MIDDECL CANPC_optimize_rcv_speed_mb3(void);

/* +--- CANPC_enable_dyn_obj_buf_mb3     ---------------------------------------*/

PRAEDECL int MIDDECL CANPC_enable_dyn_obj_buf_mb3(void);

/* +--- CANPC_enable_timestamps_mb3      ---------------------------------------*/
/* this function has no effect on the CANcard                               */
#define  CANPC_ET_NO_FIFO                 -6  /* fifo not enabled 
                                                 (only CAN-AC2)             */

PRAEDECL int MIDDECL CANPC_enable_timestamps_mb3(void);
/* +--- CANPC_enable_fifo_transmit_ack_mb3  ------------------------------------*/

PRAEDECL int MIDDECL CANPC_enable_fifo_transmit_ack_mb3 (void);

PRAEDECL int MIDDECL CANPC_enable_fifo_transmit_ack2_mb3(void);

/* +--- CANPC_get_version_mb3            ---------------------------------------*/
/* the parameter hw_version is not used with the CAN-AC2                    */

PRAEDECL int MIDDECL CANPC_get_version_mb3(int  * sw_version, 
                                       int  * fw_version,
                                       int  * hw_version,
                                       int  * license,
                                       int  * can_chip_type);

/* +--- CANPC_get_serial_number_mb3      ---------------------------------------*/
/* this function has no effect on the CAN-AC2                               */

PRAEDECL int MIDDECL CANPC_get_serial_number_mb3(unsigned long  * ser_number);

/* +--- CANPC_start_chip_mb3             ---------------------------------------*/

PRAEDECL int MIDDECL CANPC_start_chip_mb3(void);

/* +--- CANPC_send_remote_object_mb3(2)  ---------------------------------------*/
#define  CANPC_SRO_PEND                   -1  /* last request still pending */    
#define  CANPC_SRO_TX_FIFO_FULL           -3  /* transmit fifo full         */    

PRAEDECL int MIDDECL CANPC_send_remote_object_mb3 (int ObjectNumber,
                                  int DataLength);

PRAEDECL int MIDDECL CANPC_send_remote_object2_mb3(int ObjectNumber,
                                  int DataLength);

/* +--- CANPC_supply_object_data_mb3(2)  ---------------------------------------*/
#define  CANPC_SOD_REQ_OVR                -1  /* request overrun            */    

PRAEDECL int MIDDECL CANPC_supply_object_data_mb3 (int  ObjectNumber,
                                  int  DataLength,
                                  unsigned char  * pData);

PRAEDECL int MIDDECL CANPC_supply_object_data2_mb3(int  ObjectNumber,
                                  int  DataLength,
                                  unsigned char  * pData);

/* +--- CANPC_supply_rcv_object_data_mb3(2)-------------------------------------*/

PRAEDECL int MIDDECL CANPC_supply_rcv_object_data_mb3 (int  ObjectNumber,
                                      int  DataLength,
                                      unsigned char  * pData);

PRAEDECL int MIDDECL CANPC_supply_rcv_object_data2_mb3(int  ObjectNumber,
                                      int  DataLength,
                                      unsigned char  * pData);

/* +--- CANPC_send_object_mb3(2)         ---------------------------------------*/
#define  CANPC_SO_REQ_OVR                 -1  /* request overrun            */    
#define  CANPC_SO_FIFO_FULL               -3  /* job fifo full              */    

PRAEDECL int MIDDECL CANPC_send_object_mb3 (int  ObjectNumber,
                           int  DataLength);

PRAEDECL int MIDDECL CANPC_send_object2_mb3(int  ObjectNumber,
                           int  DataLength);

/* +--- CANPC_write_object_mb3(2)        ---------------------------------------*/
#define  CANPC_WO_REQ_OVR                 -1  /* request overrun            */    
#define  CANPC_WO_FIFO_FULL               -3  /* transmit fifo full         */    

PRAEDECL int MIDDECL CANPC_write_object_mb3 (int  ObjectNumber,
                            int  DataLength,
                            unsigned char  * pData);

PRAEDECL int MIDDECL CANPC_write_object2_mb3(int  ObjectNumber,
                            int  DataLength,
                            unsigned char  * pData);

/* +--- CANPC_read_rcv_data_mb3(2)       ---------------------------------------*/
...
PRAEDECL int MIDDECL CANPC_read_rcv_data_mb3 (int  ObjectNumber,
                             unsigned char  * pRCV_Data,
                             unsigned long  * Time);

PRAEDECL int MIDDECL CANPC_read_rcv_data2_mb3(int  ObjectNumber,
                             unsigned char  * pRCV_Data,
                             unsigned long  * Time);

/* +--- CANPC_read_xmt_data_mb3(2)       ---------------------------------------*/
...
PRAEDECL int MIDDECL CANPC_read_xmt_data_mb3 (int  ObjectNumber,
                             int  * pDataLength,
                             unsigned char  * pXMT_Data);

PRAEDECL int MIDDECL CANPC_read_xmt_data2_mb3(int  ObjectNumber,
                             int  * pDataLength,
                             unsigned char  * pXMT_Data);
...
PRAEDECL int MIDDECL CANPC_read_ac_mb3(param_struct  * param);

/* +--- CANPC_send_data_mb3              ---------------------------------------*/
#define  CANPC_SD_FIFO_FULL               -1  /* transmit fifo full         */    

PRAEDECL int MIDDECL CANPC_send_data_mb3 (unsigned long Ident,
                         int Xtd,
                         int DataLength,
                         unsigned char  * pData);

PRAEDECL int MIDDECL CANPC_send_data2_mb3(unsigned long Ident,
                         int Xtd,
                         int DataLength,
                         unsigned char  * pData);

/* +--- CANPC_send_remote_mb3            ---------------------------------------*/
#define  CANPC_SR_FIFO_FULL               -1  /* transmit fifo full         */    
PRAEDECL int MIDDECL CANPC_send_remote_mb3 (unsigned long Ident,
                           int Xtd,
                           int DataLength);

PRAEDECL int MIDDECL CANPC_send_remote2_mb3(unsigned long Ident,
                           int Xtd,
                           int DataLength);

/* +--- CANPC_get_trigger_mb3(2)            ---------------------------------------*/
/* these functions have no effect on the CANcard                               */
PRAEDECL int MIDDECL CANPC_get_trigger_mb3 (int  * level);

PRAEDECL int MIDDECL CANPC_get_trigger2_mb3(int  * level);

/* +--- CANPC_set_trigger_mb3            ---------------------------------------*/
#define  CANPC_ST_FIFO_FULL               -1  /* transmit fifo full         */    

PRAEDECL int MIDDECL CANPC_set_trigger_mb3 (int level);

PRAEDECL int MIDDECL CANPC_set_trigger2_mb3(int level);

/* +--- CANPC_reinitialize_mb3           ---------------------------------------*/
PRAEDECL int MIDDECL CANPC_reinitialize_mb3(void);

/* +--- CANPC_get_time_mb3               ---------------------------------------*/
PRAEDECL int MIDDECL CANPC_get_time_mb3(unsigned long  * time);

/* +--- CANPC_get_bus_state_mb3          ---------------------------------------*/
...
PRAEDECL int MIDDECL CANPC_get_bus_state_mb3(int Can);


/* +--- CANPC_reset_rcv_fifo_mb3         ---------------------------------------*/
PRAEDECL int MIDDECL CANPC_reset_rcv_fifo_mb3(void);

/* +--- CANPC_reset_xmt_fifo_mb3         ---------------------------------------*/
PRAEDECL int MIDDECL CANPC_reset_xmt_fifo_mb3(void);

/* +--- CANPC_reset_lost_msg_counter_mb3  --------------------------------------*/
PRAEDECL int MIDDECL CANPC_reset_lost_msg_counter_mb3(void);

/* +--- CANPC_read_rcv_fifo_level_mb3    ---------------------------------------*/
/* returns number of items in receive fifo   */
PRAEDECL int MIDDECL CANPC_read_rcv_fifo_level_mb3(void);

/* +--- CANPC_read_xmt_fifo_level_mb3    ---------------------------------------*/
/* returns number of items in transmit fifo  */
PRAEDECL int MIDDECL CANPC_read_xmt_fifo_level_mb3(void);

/* +--- CANPC_set_path_mb3               ---------------------------------------*/
#define  CANPC_SP_STRING_TOO_LONG        -1  /* path string too long        */    
PRAEDECL int MIDDECL CANPC_set_path_mb3(char  * path);

/* +--- INIPC_close_board_mb3            ---------------------------------------*/
PRAEDECL int MIDDECL INIPC_close_board_mb3(void);
#define  INIPC_CB_ERR                     -1  /* error unlocking rerssources*/    

/* +--- CANPC_enable_error_frame_detection_mb3  --------------------------------*/
/* this function has no effect on the CAN-AC2                               */
PRAEDECL int MIDDECL CANPC_enable_error_frame_detection_mb3(void);
