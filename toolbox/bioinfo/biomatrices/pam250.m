function [matrix, matrixInfo] = pam250
...
%
%   [MATRIX,MATRIXINFO] = PAM250 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'PAM250';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 0.354 ;
    matrixInfo.ExpectedScore = -0.844;
