function [t,x,y] = rk45(sys, time, X0, V1_Options, ut, varargin)
%RK45 Simulink 1.x RK45 integration algorithm.
%   RK45 is obsolete and will be eliminated in future versions.  Use SIM
%   instead.  RK45 is mapped to the Simulink 3 'ode45' algorithm.
%
%   See also SIM.
