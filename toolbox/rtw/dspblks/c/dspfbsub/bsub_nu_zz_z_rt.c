/*
 * bsub_nu_zz_z_rt.c - Signal Processing Blockset backward substitution run-time function 
 ...
 *  $Revision: 1.4.2.3 $  $Date: 2004/04/12 23:42:55 $
 *
 */

#include "dsp_rt.h"

EXPORT_FCN void MWDSP_BSub_NU_ZZ_Z(
        const creal_T *pU,
        const creal_T *pb,
              creal_T  *x,
        const int_T     N,
