function [matrix, matrixInfo] = pam150
%PAM150 substitution matrix in 1/2 bit units,
...
%
%   [MATRIX,MATRIXINFO] = PAM150 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'PAM150';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 0.754 ;
    matrixInfo.ExpectedScore = -1.25;
