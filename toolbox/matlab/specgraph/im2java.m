...
%   $Revision: 1.7 $  $Date: 2002/06/17 13:39:26 $
...
switch nargin
  case 1
    ...
    elseif isa(img, 'uint8')
        ...
        error('Intensity or RGB image must be uint8, uint16, or double.');
    end
  ...
  case 2
    ...
    index_out_msg = 'Invalid indexed image: an index falls outside colormap.';
