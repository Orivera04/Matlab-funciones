echo on; clc;
%---------------------------------------------------------------------------
%A10_2   MATLAB script file for implementing Algorithm 10.2
%
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%
% Example 10.3, page 511.  Use the forward difference method
...
diary off,echo on
pause % Press any key to perform the forward difference method.
...
zlabel('u');
view([1 1 1]);
Mx1 = 'An unstable forward difference solution to the heat equation.';
title(Mx1);
figure(gcf); pause % Press any key to continue.
