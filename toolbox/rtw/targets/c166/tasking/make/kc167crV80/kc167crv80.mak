...
PROJ    = kc167crv80
PROJDIR = d:\aetargets\matlab\toolbox\rtw\targets\c166\tasking\make\kc167crv80
...
OPT_LC  = -trap -libfmtiol PRINT("$*.map") -Ms -xmifp -Bhoeufmknladij  -cf "_kc167crv80.ilo"
OPT_OPIHEX = -l32
OPT_XVW = -G "." -tcfg "d:\aetargets\matlab\toolbox\rtw\targets\c166\tasking\make\kc167crv80\_kc167crv80.cfg" -D RS232,COM1:,19200 --single_instance -i --load_application_download=true --enable_flash=true --load_application_signal=true --load_application_program_reset=true --load_application_target_reset=true --load_application_goto_main=true --load_application_break_on_exit=true -a 100 -b 200 -s 26

all : $(PROJ).abs $(PROJ).hex

main.obj : main.c <1079341435>
