...
/* MIL-HDBK-310 atmosphere profile models */
...
static double altitude310[NUMPROFILEPTS] = {  /* in m */
 ...
 *
 */
void InitCalcAtmosProfile310( SFcnCache *udata,
                              ...
                              double density310[])
{
    ...
    udata->upper_alt = altitude310[NUMPROFILEPTS - 1];
            ...
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht5k1p[i];
                        density310[i] = htd5k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht5k10p[i];
                        density310[i] = htd5k10p[i];
                    }
                  }
                break;
            }break;
          case K10:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht10k1p[i];
                        density310[i] = htd10k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht10k10p[i];
                        density310[i] = htd10k10p[i];
                    }
                  }
                break;
            }break;
          case K20:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht20k1p[i];
                        density310[i] = htd20k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht20k10p[i];
                        density310[i] = htd20k10p[i];
                    }
                  }
                break;
            }break;
          case K30:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht30k1p[i];
                        density310[i] = htd30k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht30k10p[i];
                        density310[i] = htd30k10p[i];
                    }
                  }
                break;
            }break;
          case K40:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht40k1p[i];
                        density310[i] = htd40k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ht40k10p[i];
                        density310[i] = htd40k10p[i];
                    }
                  }
                break;
            }break;
          ...
          case K5:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt5k1p[i];
                        density310[i] = ltd5k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt5k10p[i];
                        density310[i] = ltd5k10p[i];
                    }
                  }
                break;
            }break;
          case K10:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt10k1p[i];
                        density310[i] = ltd10k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt10k10p[i];
                        density310[i] = ltd10k10p[i];
                    }
                  }
                break;
            }break;
          case K20:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt20k1p[i];
                        density310[i] = ltd20k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt20k10p[i];
                        density310[i] = ltd20k10p[i];
                    }
                  }
                break;
            }break;
          case K30:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt30k1p[i];
                        density310[i] = ltd30k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt30k10p[i];
                        density310[i] = ltd30k10p[i];
                    }
                  }
                break;
            }break;
          case K40:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt40k1p[i];
                        density310[i] = ltd40k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = lt40k10p[i];
                        density310[i] = ltd40k10p[i];
                    }
                  }
                break;
            }break;
          ...
          case K5:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt5k1p[i];
                        density310[i] = hd5k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt5k10p[i];
                        density310[i] = hd5k10p[i];
                    }
                  }
                break;
            }break;
          case K10:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt10k1p[i];
                        density310[i] = hd10k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt10k10p[i];
                        density310[i] = hd10k10p[i];
                    }
                  }
                break;
            }break;
          case K20:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt20k1p[i];
                        density310[i] = hd20k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                static double hdt20k10p[NUMPROFILEPTS] = {  /* in K */ 
                    ...
                    189.211000,
                    198.134000,	207.652000,	214.014000,	218.369000,    
                    222.720000,
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt20k10p[i];
                        density310[i] = hd20k10p[i];
                    }
                  }
                break;
            }break;
          case K30:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt30k1p[i];
                        density310[i] = hd30k1p[i];
                    }
                  }
                break;
             case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt30k10p[i];
                        density310[i] = hd30k10p[i];
                    }
                 }
                break;
            }break;
          case K40:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt40k1p[i];
                        density310[i] = hd40k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = hdt40k10p[i];
                        density310[i] = hd40k10p[i];
                    }
                  }
                break;
            }break;
            ...
            switch (udata->ppercent) {
              case PP1:
                ...
                static double ld5k1p[NUMPROFILEPTS] = {  /* in kg/m^3 */ 
                    ...
                    1.312000e-002,	1.331000e-002,	9.815000e-003,	
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt5k1p[i];
                        density310[i] = ld5k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt5k10p[i];
                        density310[i] = ld5k10p[i];
                    }
                  }
                break;
            }break;
          case K10:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt10k1p[i];
                        density310[i] = ld10k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt10k10p[i];
                        density310[i] = ld10k10p[i];
                    }
                  }
                break;
            }break;
          case K20:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt20k1p[i];
                        density310[i] = ld20k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt20k10p[i];
                        density310[i] = ld20k10p[i];
                    }
                  }
                break;
            }break;
          case K30:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt30k1p[i];
                        density310[i] = ld30k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt30k10p[i];
                        density310[i] = ld30k10p[i];
                    }
                  }
                break;
            }break;
          case K40:
            switch (udata->ppercent) {
              case PP1:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt40k1p[i];
                        density310[i] = ld40k1p[i];
                    }
                  }
                break;
              case PP10:
                ...
                for ( i = 0; i < NUMPROFILEPTS; i++ )
                    {
                        temperature310[i] = ldt40k10p[i];
                        density310[i] = ld40k10p[i];
                    }
                  }
                break;
            }break;
...
void CalcAtmosProfile310(const double *altitude,
                         double temperature310[],
                         double density310[], 
                         double *temp, 
                         double *pressure, 
		         ...
		         double upper_alt)
{
    ...
    for (i=0; i<numPoints; i++) {
        ...
        tempGrad = (temperature310[idx+1]-temperature310[idx])/
