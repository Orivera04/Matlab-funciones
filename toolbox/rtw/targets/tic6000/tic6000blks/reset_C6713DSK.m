function reset_C6713DSK()
% reset the C6713 DSK board

% $RCSfile: reset_C6713DSK.m,v $
% $Revision: 1.1.6.1 $ $Date: 2004/01/22 18:28:38 $
...
try
    ...
    if isempty(boardProc),
        ...
        errordlg(msg,'C6713DSK Reset Status', 'modal');
    else
        warnState = warning;
        warning off;
