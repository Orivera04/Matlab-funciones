/**********************/  
/* 
 * blms_an_wy_zz_rt.c - Signal Processing Blockset Block LMS adaptive filter run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.1.6.1 $  $Date: 2003/12/06 15:53:31 $ 
 */  
#include "dsp_rt.h" 
#include "dspblms_rt.h" 

 
EXPORT_FCN   void MWDSP_blms_an_wy_ZZ(   const creal_T *inSigU, 
