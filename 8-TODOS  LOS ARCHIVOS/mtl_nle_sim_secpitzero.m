...
% Simulation : Pitfall - Division by zero
% Language   : Matlab r12
% Authors    : Nathan Collier, Autar Kaw
% Date       : 6 September 2002
% Abstract   : This simulation shows the pitfall of division by zero of the secant method % %              for finding roots of an equation f(x)=0
%
