...
%   Hd = DFILT.DF1SOS(S) returns a discrete-time, second-order section, 
%   direct form I filter object, Hd, with coefficients given in the S matrix. 
% 
...
%
%   % Example: Form a Direct-Form I, Second-Order Sections discrete-time filter 
%   % with coefficients from a 6th order low-pass elliptic design.                                                         
%   [z,p,k] = ellip(6,1,60,.4);                                                  
%   [s,g] = zp2sos(z,p,k);                                                     
%   Hd = dfilt.df1sos(s,g)  
%
%   See also DFILT/DF1, DFILT/DF1T, DFILT/DF1TSOS, DFILT/DF2
%   DFILT/DF2SOS, DFILT/DF2T, DFILT/DF2TSOS.

%   Author: P. Costa
%   Copyright 1988-2004 The MathWorks, Inc.
%   $Revision: 1.2.4.2 $  $Date: 2004/04/12 23:59:56 $

Hd = dfilt.df1sos(varargin{:});
