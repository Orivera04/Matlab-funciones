function [OK,err]=xreg_startup(h)
% XREG_STARTUP  Startup tasks for The Model-Based Calibration Toolbox
%
%   xreg_startup(t)  where t is a uicontrol text object
%   which can be updated to display the current startup task.
%

%  Copyright 2000-2004 The MathWorks, Inc. and Ford Global Technologies, Inc.

%  $Revision: 1.9.4.3 $  $Date: 2004/02/09 08:21:09 $
...
try
    ...
    findclass(findpackage('xregdesgui'));
    findclass(findpackage('xregdatagui'));
    findclass(findpackage('xregMdlGui'));
    findclass(findpackage('xregtools'));
catch
    OK=0;
