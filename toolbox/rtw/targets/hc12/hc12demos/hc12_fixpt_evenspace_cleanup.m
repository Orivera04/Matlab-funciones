function xdata_adjusted = hc12_fixpt_evenspace_cleanup(xdata_original,xdt,xscale)
%HC12_FIXPT_EVENSPACE_CLEANUP adjust fixed point data for even spacing
%XDATA_ADJUSTED = HC12_FIXPT_EVENSPACE_CLEANUP(XDATA_ORIGINAL,XDT,XSCALE)
