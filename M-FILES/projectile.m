clear;
clc;
d = input( 'ángulo de lanzamiento en grados: ' );                           
...
title('posición (x,y) en el tiempo t')
...
taltmax=u*sin(a)/g %tiempo para alcanzar la altura máxima.
disp('altura máxima: ');
altmax=u * sin(a)* taltmax  - 0.5 * g * taltmax^ 2 %altura máxima.
disp('posición final: ');
x=x(end)
y=y(end)
