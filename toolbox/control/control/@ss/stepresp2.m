...
%  STEPRESP  Step response of a single LTI model in state-space format.
%
...
%  $Revision: 1.2 $  $Date: 2001/09/14 20:03:24 $
...
% Extract discrete-time delays and reduce to a pair (TDIN,TDOUT) of input
% and output delays to be used in the simulation of each input channel.
if ComputeX
