 ...
 *  $Revision: 1.3 $  $Date: 2002/04/14 16:33:56 $
 */
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sis95lcgen2
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if(!ssSetOutputPortMatrixDimensions(S, 0, numSymb, 1)) return;
