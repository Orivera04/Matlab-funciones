function [ChkCurve, DefCurve] = creditcurvestand()
%CREDITCURVESTAND Credit Curve Structure Defaults/Argument Checking Values
%
...
%$Revision: 1.5 $   $Date: 2002/04/14 21:52:18 $ 


%Assign all acceptable color values to the ChkTree structure
ChkCurve.CreditRates = [-inf 0 inf];
ChkCurve.CurveDates = [];
...
%end of CREDITCURVESTAND function
