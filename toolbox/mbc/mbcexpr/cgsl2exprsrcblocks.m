function [srcblock,line] = cgsl2exprsrcblocks(b,varargin)
%CGSL2EXPRSRCBLOCKS - Find the source block(s) for this block
%
%  [srcBlock,Line] = cgSL2ExprSrcBlocks(blockHandle,<fieldName>)
%  

%  Copyright 2000-2004 The MathWorks, Inc. and Ford Global Technologies, Inc.

%  $Revision: 1.2.6.2 $    $Date: 2004/02/09 07:17:42 $ 
srcblock=[];
line = [];
