 ...
 *      partition is a length N-1 vector and codebook is a length N vector. 
 *      The output of this block is a length 3N vector with the first N 
 *      elements being the index, which is one of the N integers in the range 
 *      [0 : N-1]. The second N elements are the quantized output. The last 
 *      N elements of the output vector are the estimation of the distortion.
 *
 * Wes Wang 10/6, 1994
 *
...
{
    int_T Num_Input       = ssGetNumInputs(S) - 1;
