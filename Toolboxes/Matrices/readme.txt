...
(or folder), possibly named ILA6, and that the name of the
...
Make a subdirectory in your \matlab subdirectory called ila6.

Copy the contents of the diskette into \matlab\ila6.
...
Select Open m-file.
   ...
   > To check things, type path in MATLAB. You should see that 
     subdirectory \ila6 is in the path displayed. 
     If not, carefully repeat the above procedure.

   > To see a listing of the contents of ila6, at a MATLAB prompt, type
       help ila6.
