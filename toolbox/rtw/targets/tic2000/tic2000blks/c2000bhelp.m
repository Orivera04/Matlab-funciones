function html = c2000bhelp(fileStr)
% C2000BHELP C2000 on-line help function.
%   Points Web browser to the HTML help file corresponding to this
%   TI DDK block.  The current block is queried for its MaskType.
%
%   Typical usage:
%      set_param(gcb,'MaskHelp','web(c2000help);');

% Copyright 2003-2004 The MathWorks, Inc.
% $Revision: 1.1.6.2 $ $Date: 2004/04/08 20:58:41 $
