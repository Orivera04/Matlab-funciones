function [convBaseAddr] = menccbcioquadcount (flag, Module, BaseAddr, slot, BoardType)

% MENCCBCIOQUADCOUNT - InitFcn and Mask Initialization for CB CIO-QUAD series
% board

% Copyright 1996-2003 The MathWorks, Inc.
% $Revision: 1.1.4.1 $ $Date: 2003/11/13 06:22:34 $
...
display = strcat(display,'port_label(''output'',1,''Count'')');
