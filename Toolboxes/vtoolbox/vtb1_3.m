...
%       file.  The equations in the function file must be written
%       in first order state space form.
%       See example VTB1_3ex.m.
%       Example
%       t=0:.5:20;  % Creates time vector
%       u=[zeros(1,length(t));sin(t*1.1)];% Creates force matrix
%       %(must be zeros on top, don't edit the first row)
%       x0=[1 ;0];  % Creates initial state vector. Initial
%       %displacement of 1, initial velocity of 0.
%       x=vtb1_3('vtb1_3ex',u,t,x0); % Runs analysis.
