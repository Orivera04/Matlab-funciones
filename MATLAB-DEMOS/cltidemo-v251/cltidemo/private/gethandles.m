...
% Jordan Rosenthal, 14-Jun-99: Extracted original code from dltidemo 'Initialize' case
...
h.Slider.FilterBW    = findobj(gcf, 'Tag', 'FilterSBW');
...
h.Edit.FilterBW    = findobj(gcf, 'Tag', 'FilterEdBW');
...
h.Text.FilterBW = findobj(gcf, 'Tag', 'FilterBWText');
...
h.FilterBWGroup = [h.Slider.FilterBW; h.Edit.FilterBW; h.Text.FilterBW];
h.IntegratorGroup = [h.Text.FilterFreq1 ];
h.FilterSpecs   = [h.PhaseGroup; h.FreqGroup];
