/*
 *  ALLPOLE_TDF_RC_RT.C - Filter block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:41:20 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_AllPole_TDF_RC(const real32_T          *u,
                          creal32_T               *y,
