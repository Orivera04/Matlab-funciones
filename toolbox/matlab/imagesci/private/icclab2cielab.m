function cielab = icclab2cielab(icclab)
...
%   $Revision: 1.1.6.1 $  $Date: 2003/12/13 03:00:14 $

input_class = class(icclab);

cielab = double(icclab);

if strcmp(input_class, 'uint16')
    % Fix L* values.
    cielab(:,:,1) = round(cielab(:,:,1) * (65535/65280));
