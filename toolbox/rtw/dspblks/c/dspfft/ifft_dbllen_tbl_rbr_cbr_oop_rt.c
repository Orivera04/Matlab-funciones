/*
 * ifft_dbllen_tbl_rbr_cbr_oop_rt.c- Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.5.2.3 $  $Date: 2004/04/12 23:44:07 $
 */
 ...
 *
 */
EXPORT_FCN void MWDSP_Ifft_DblLen_TBL_Rbr_Cbr_Oop(
    creal32_T       *y,
    const real32_T  *x,
    const int_T      fftLen,
...
/* [EOF] ifft_dbllen_tbl_rbr_cbr_oop_rt.c */
