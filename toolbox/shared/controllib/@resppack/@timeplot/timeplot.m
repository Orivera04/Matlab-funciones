...
%  TIMEPLOT  Constructor for @timeplot class
%
%  H = TIMEPLOT(AX,[M N]) creates a @timeplot object with an M-by-N grid of
%  axes (@axesgrid object) in the area occupied by the axes with handle AX.
%
%  H = TIMEPLOT([M N]) uses GCA as default axes.
%
%  H = TIMEPLOT([M N],'Property1','Value1',...) initializes the plot with the
%  specified attributes.

%  Author(s): Bora Eryilmaz
%  Revised:
%  Copyright 1986-2004 The MathWorks, Inc.
%  $Revision: 1.1.6.2 $ $Date: 2004/04/11 00:24:12 $
