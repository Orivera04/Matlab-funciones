function [t,x,y] = rk23(sys, time, X0, V1_Options, ut, varargin)
%RK23 Simulink 1.x rk23 integration algorithm.
%   RK23 is obsolete and will be eliminated in future versions.  Use SIM
%   instead.  RK23 is mapped to the Simulink 3 'ode23' algorithm.
%
%   See also SIM.
...
simOptions = compat13('ode23',X0,V1_Options);
