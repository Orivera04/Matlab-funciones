function [matrix, matrixInfo]  = blosum50
%BLOSUM50 Clustered Scoring Matrix in 1/3 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 50
%   Entropy =   0.4808, Expected Score =  -0.3573
%   Lowest Score = -5, Highest Score = 15
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM50 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM50';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 0.4808;
    matrixInfo.ExpectedScore =  -0.3573;
