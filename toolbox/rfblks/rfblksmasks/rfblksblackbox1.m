function varargout = rfblksblackbox1(block, action)
%RFBLKSBLACKBOX1 Mask function for the black box blocks

%   Copyright 2003-2004 The MathWorks, Inc.
%   $Revision: 1.1.6.8 $  $Date: 2004/05/08 03:15:44 $

% % If it is library, call the default setting
if strcmpi(get_param(gcs, 'Name'), 'rfblackbox1')
