function varargout = commblkbernoullisrc(block, varargin)
% COMMBLKBERNOULLISRCSRC Mask dynamic dialog function for Bernoulli source block

% Author: Trefor Delve
% Copyright 1996-2002 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2003/01/26 18:44:28 $
...
%   feval(mfilename,block,'UpdateBlocks',Args);
	[varargout{1:5}] = feval(mfilename,block,'UpdateWs',Args);
