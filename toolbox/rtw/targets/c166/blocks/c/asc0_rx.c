 ...
 *
 * $Revision: 1.3.4.2 $
 * $Date: 2004/04/19 01:17:25 $
 *
 * Copyright 2002-2003 The MathWorks, Inc.
 */

#define S_FUNCTION_NAME asc0_rx
...
enum { E_SAMPLE_TIME=0, E_SHOW_LENGTH, E_SHOW_BYTES_READ, 
       E_MAX_LENGTH, P_NPARMS };
...
static void mdlInitializeSizes(SimStruct *S)
{
        ...
        if (!ssSetNumInputPorts(S, (int_T) P_SHOW_LENGTH)) return;

        if (!ssSetNumOutputPorts(S, (1 + (int_T) P_SHOW_BYTES_READ) )) return;
