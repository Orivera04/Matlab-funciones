...
%TWOWIRE Constructor.
%   H = RFCKT.TWOWIRE('PROPERTY1',VALUE1,'PROPERTY2',VALUE2,...) returns a
%   two-wire transmission line object, H, based on the specified
%   properties. The properties include,
% 
%           Name: 'Two-Wire Transmission Line' (read only)
%          nPort: 2 (read only)
...
%   $Revision: 1.1.6.7 $  $Date: 2004/04/20 23:19:40 $

h = rfckt.twowire;

% Set the values for the properties
set(h, varargin{:}, 'Name', 'Two-Wire Transmission Line');

% LS(1) = handle.listener(h, h.findprop('Radius'), 'PropertyPostSet', @update);
