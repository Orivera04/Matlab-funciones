/* $Revision: 1.5 $ $Date: 2002/03/25 04:05:03 $ */
/* daadvpcl812.c - xPC Target, non-inlined S-function driver for Advantech PCL-812 family D/A section */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME  daadvpcl812
...
static void DA_Output(SimStruct *S, uint_T device, uint_T channel, real_T value)
{
real_T out, range;

    range=mxGetPr(RANGE_ARG)[(uint_T)channel];
    ...
    rl32eOutpW(BASE+4+2*channel,((uint_T)out));
}
#endif
...
uint_T i;
    ...
    for (i=0;i<mxGetNumberOfElements(CHANNEL_ARG);i++) {
        ...
        DA_Output(S, DEVICE, (uint_T)mxGetPr(CHANNEL_ARG)[i]-1, *uPtrs[0]);
    }
