function varargout = sysEq(varargin)
% SYSEQ M-file for sysEq.fig
...
%      applied to the GUI before sysEq_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sysEq_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sysEq

% Last Modified by GUIDE v2.5 25-Apr-2007 16:08:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sysEq_OpeningFcn, ...
                   'gui_OutputFcn',  @sysEq_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before sysEq is made visible.
function sysEq_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sysEq (see VARARGIN)

% Choose default command line output for sysEq
...
%knownVal=[handles.constText;handles.ICText]
...
%modVerTxtEq(ithEq,allEq,newFtnStr);%the only way to cleanly modify a text
...
% UIWAIT makes sysEq wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = sysEq_OutputFcn(hObject, eventdata, handles) 
...
set(handles.numIter_Static,'string',['numIter:' get(hObject,'String')]);
guidata(hObject, handles);
