function [t,x,y] = euler(sys, time, X0, V1_Options, ut, varargin)
%EULER Simulink 1.x EULER integration algorithm.
%   EULER is obsolete and will be eliminated in future versions.  Use SIM
%   instead.  EULER is mapped to the Simulink 3 'ode1' algorithm.
%
%   See also SIM.
...
simOptions = compat13('ode1',X0,V1_Options);
