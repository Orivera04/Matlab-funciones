...
%   tree. Options are: 'phylogram' (default, also knwon as dendrogram),
%   'cladogram', and 'radial'.
%
...
%   true or false (default). Branch labels are placed next to the branch
%   node.
%
%   PLOT(...,'LEAFLABELS',value) hides/unhides leaf labels. Options are
%   true or false (default). Leaf labels are placed next to the leaf nodes.
%
...
% $Revision: 1.1.6.6 $ $Author: batserve $ $Date: 2004/04/01 15:58:50 $
