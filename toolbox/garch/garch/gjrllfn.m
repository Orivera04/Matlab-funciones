function [LLF, G, H, e, h, LogLikelihoods] = gjrllfn(Parameters, y, R, M, P, Q, X, isConstantInMean, isVarianceInMean, e0, s0, y0)
%GJRLLFN Univariate GJR process objective function (Gaussian Distribution).
...
%   conditional variances are then fit to a GJR model. Gaussian innovations
%   are assumed.
%
%   [LLF, G, H, Innovations, Sigmas, LogLikelihoods] = gjrllfn(Parameters, 
...
%   $Revision: 1.1.4.1 $   $Date: 2003/05/08 21:45:32 $
