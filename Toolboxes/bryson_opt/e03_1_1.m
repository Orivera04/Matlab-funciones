% Script e03_1_1.m; DTDP for max uf (no gravity) with spec. (yf,vf)
% using analytical soln; th0 found by interpolation to give yf=.2;
%                                                   11/96, 6/24/02
%
...
hold on; for i=1:N, pltarrow([x(i) xt(i)],[y(i) yt(i)],.01,'r','-');
