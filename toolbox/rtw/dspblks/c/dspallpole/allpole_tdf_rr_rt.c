/*
 *  ALLPOLE_TDF_RR_RT.C - Filter block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:41:21 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_AllPole_TDF_RR(const real32_T         *u,
                          real32_T               *y,
