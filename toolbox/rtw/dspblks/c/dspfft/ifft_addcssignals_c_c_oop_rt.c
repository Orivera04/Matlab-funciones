/*
 * ifft_addcssignals_c_c_oop_rt.c - Signal Processing Blockset IFFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.7.2.3 $  $Date: 2004/04/12 23:43:54 $
 */
 ...
 * 
 */
EXPORT_FCN void MWDSP_Ifft_AddCSSignals_C_C_OOP(
    creal32_T *y,
    const creal32_T *u,
    const int_T   nChans,
    const int_T   nRows
...
/* [EOF] ifft_addcssignals_c_c_oop_rt.c */
