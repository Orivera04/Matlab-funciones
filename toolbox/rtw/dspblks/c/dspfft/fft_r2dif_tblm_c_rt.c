/*
 * fft_r2dif_tblm_c_rt.c - Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.5.2.3 $  $Date: 2004/04/12 23:43:38 $
 */

#include "dspfft_rt.h"

EXPORT_FCN void MWDSP_R2DIF_TBLM_C(
    creal32_T      *y,
    int_T           nChans,
    const int_T     nRows,
    const int_T     fftLen,
