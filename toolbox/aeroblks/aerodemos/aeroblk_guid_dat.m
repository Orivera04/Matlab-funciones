% AEROBLK_GUID_DAT	Initialization file for missile guidance model
%
% See also: aeroblk_guidance

%   Copyright 1990-2003 The MathWorks, Inc.
%   $Revision: 1.1.2.2 $  $Date: 2004/04/06 01:04:25 $

disp('Loading data from file aeroblk_guid_dat.m ...')
...
Cx_alpha = repmat(-0.3,length(alpha_vec),length(Mach_vec));
