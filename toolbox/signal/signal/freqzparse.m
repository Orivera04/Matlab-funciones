...
%   $Revision: 1.3.4.2 $  $Date: 2004/04/13 00:17:59 $
...
% instead of normalizing.  so if the user didnt specify an fs we need to
...
switch nargin
    ...
    case 3,
        ...
        elseif ischar(varargin{3}),
            ...
            error(generatemsgid('InvalidFrequencyRange'), ...
                'The frequency range must be the string ''half'' or ''whole''.');
        end
end
