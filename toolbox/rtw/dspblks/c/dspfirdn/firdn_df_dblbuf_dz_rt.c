/*
 *  firdn_df_dblbuf_dz_rt.c - FIR Decimation block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:44:59 $
 *
...
EXPORT_FCN void MWDSP_FIRDn_DF_DblBuf_DZ(
    const real_T    *u,
          creal_T   *yout,
          real_T    *tap0,
          creal_T   *sums,
