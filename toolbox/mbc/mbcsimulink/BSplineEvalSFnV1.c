...
#define S_FUNCTION_NAME  BSplineEvalSFnV1
...
#define LIMITS			ssGetSFcnParam(S,6)
...
/* Function prototypes */
//static void SetKnot(double *K, int s, double *knots, int sizek, double, double);
//static void SetInit(SimStruct *S,double *X,double *xget,int os, int sizek, int sizex, double *K);
