function varargout = commblkgaussiansrc(block, varargin)
% COMMBLKGAUSSIANSRC Mask dynamic dialog function for Gaussian source block

% Author: Trefor Delve
% Copyright 1996-2002 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2003/01/26 18:44:34 $
...
if(strcmp(action,'UpdateWs'))
   [varargout{1:3}]=gwnoise(Mask_m,Mask_d,Mask_s);
end;
