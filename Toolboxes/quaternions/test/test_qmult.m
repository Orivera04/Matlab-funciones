...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
q3=qnorm([0.2 -1.0  0.5 0.3].'),disp(' ')
q4=qnorm([2.0  1.5 -1.0 0.5].'),disp(' ')
q3q4 = [ ...
    '(q3.''*[ q4(4) -q4(3)  q4(2) -q4(1)', 10, ...
    '        q4(3)  q4(4) -q4(1) -q4(2)', 10, ...
    '       -q4(2)  q4(1)  q4(4) -q4(3)', 10, ...
    '        q4(1)  q4(2)  q4(3)  q4(4) ]).'''],disp(' ')
q3q4 = eval(q3q4);
truth_value = 'q3q4';
