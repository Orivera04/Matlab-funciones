...
%    $Revision: 1.7.2.4 $  $Date: 2003/08/29 04:40:12 $

error('daq:daqmem:invalidtype', 'Wrong object type passed to DAQMEM.  Use the object''s parent.');
