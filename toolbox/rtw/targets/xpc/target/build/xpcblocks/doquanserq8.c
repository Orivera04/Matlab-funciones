// doquanserq8.c - xPC Target, non-inlined S-function driver for the
// digital output section of the Quanser Q8 Data Acquisition System

// Copyright 2003 The MathWorks, Inc.

#define S_FUNCTION_LEVEL     2
#undef  S_FUNCTION_NAME
#define S_FUNCTION_NAME      doquanserq8
...
#define RESET_ARG            ssGetSFcnParam(S,2) // vector of 0:1
#define INIT_VAL_ARG         ssGetSFcnParam(S,3) // vector of 0:1
#define SAMP_TIME_ARG        ssGetSFcnParam(S,4) // double
#define PCI_BUS_ARG          ssGetSFcnParam(S,5) // int
#define PCI_SLOT_ARG         ssGetSFcnParam(S,6) // int
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    base[DIGITAL_IO_REGISTER] = output;
#endif
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    int_T   nChans = mxGetN(CHANNEL_ARG);
    reg32_T base   = (reg32_T) IWork[BASE_I_IND];
    int_T   output = base[DIGITAL_IO_REGISTER];
