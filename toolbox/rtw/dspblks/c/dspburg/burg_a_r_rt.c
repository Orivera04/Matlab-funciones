/* 
 * burg_a_r_rt - Signal Processing Blockset Burg AR Estimation run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.5.2.3 $  $Date: 2004/04/12 23:42:14 $ 
 */ 

#include "dsp_rt.h"

EXPORT_FCN void MWDSP_Burg_A_R(const int_T     N,             /* Input array length */
                    ...
                    )
{
    ...
    {
        real32_T *a = Acoef;
        *a++ = 1.0F;             /* First AR coefficient is 1 */
    }
