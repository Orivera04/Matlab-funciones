/*
 *  upfir_df_dblbuf_zz_rt.c - FIR Decimation block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:49:30 $
 *
...
EXPORT_FCN void MWDSP_UpFIR_DF_DblBuf_ZZ(
    const creal_T   *u,
          creal_T   *out,
          creal_T   *tap0,
            ...
            *mem                = *u++;
            ...
            while (m--) {   
                ...
                for (j = 0; j <= curTapIdx; j++) {
                    sum.re += CMULT_RE(*mem, *cff);
                    sum.im += CMULT_IM(*mem, *cff);
                    --mem;
                    ++cff;
                }
