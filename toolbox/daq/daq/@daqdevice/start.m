...
% 
%    See also DAQHELP, STOP, TRIGGER, PROPINFO, WAITTILSTOP.
%

%    CP 2-1-98
%    Copyright 1998-2003 The MathWorks, Inc.
%    $Revision: 1.12.2.4 $  $Date: 2003/08/29 04:41:28 $

if nargout > 0
   error('daq:start:argcheck', 'Too many output arguments.')
end
...
if nargin == 2
   if ~(isfield(event, 'Type') && isfield(event, 'Data'))
      error('daq:start:argcheck', 'Too many input arguments.');
   end
end
...
try
   ...
   error('daq:start:unexpected', lasterr)
end
