...
#define S_FUNCTION_NAME c166_can_tx 
...
enum { E_MODULE = 0, E_TX_MODE, E_BUFFERS, E_FIFO_QUEUE_LENGTH, E_INT_LEVEL, E_SAMPLE_TIME, P_NPARMS };
...
static void mdlInitializeSizes(SimStruct *S)
{
        ...
        if ( ( P_TX_MODE == TX_MODE_SHARED_QUEUE ) || ( P_TX_MODE == TX_MODE_FIFO ) ) {
