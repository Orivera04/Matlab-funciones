function [matrix, matrixInfo]  = blosum80
%BLOSUM80 Clustered Scoring Matrix in 1/3 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 80
%   Entropy =   0.9868, Expected Score =  -0.7442
%   Lowest Score = -8, Highest Score = 16
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM80 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM80';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 0.9868;
    matrixInfo.ExpectedScore =  -0.7442;
