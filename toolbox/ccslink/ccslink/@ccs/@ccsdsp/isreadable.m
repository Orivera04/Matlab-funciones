...
%   $Revision: 1.12.4.3 $ $Date: 2004/04/06 01:04:46 $
...
if nargin == 3,
    resp=callSwitchyard(cc.ccsversion,[11 cc.boardnum cc.procnum 0 0],address,datatype);
elseif nargin >= 4,
    resp=callSwitchyard(cc.ccsversion,[11 cc.boardnum cc.procnum 0 0],address,datatype,count);
end
result = (resp==1);
