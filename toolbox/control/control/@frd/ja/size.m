...
%     行ベクトルD = [NY NU S1 S2 ... Sp] 
% を出力します。SIZE(SYS) は、書式付き表示を作成します。
%
% [NY,NU,S1,...,Sp] = SIZE(SYS) は、
%   * 出力数 NY
%   * 入力数 NU
%   * LTI配列のサイズ S1,...,Sp (LTIモデルが配列のとき)
% を別々の出力引数に出力します。 つぎのように出力を選択することもできます。
...
% 出力します。LTI 配列の場合、すべてのモデルが同じ次数をもつ場合は、NSは
% スカラで、他の場合は、各モデル毎に配列で次数を出力します。
%
% FRDモデルの場合、 
%   NF = SIZE(SYS,'freq') 
% は、周波数点の数を出力します。
