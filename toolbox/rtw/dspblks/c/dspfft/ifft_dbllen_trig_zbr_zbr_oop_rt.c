/*
 * ifft_dbllen_trig_zbr_zbr_oop_rt.c- Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.7.2.3 $  $Date: 2004/04/12 23:44:17 $
 */
...

    {
...

        {
            ...
            for (i=2; i<N4; i++) {
                ...
                theta = (real_T)DSP_TWO_PI * ((real_T)i/(real_T)fftLen);
                W.re = cos(theta);
                W.im = sin(theta);
...
/* [EOF] ifft_dbllen_trig_zbr_zbr_oop_rt.c */
