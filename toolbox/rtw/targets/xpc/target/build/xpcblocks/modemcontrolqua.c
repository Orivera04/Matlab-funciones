/* $Revision: 1.2 $ $Date: 2003/01/22 20:18:30 $ */
/* modemcontrolqua.c - xPC Target, non-inlined S-function driver for reading
...
#define         S_FUNCTION_NAME         modemcontrolqua
...
#define RTS_ARG                 ssGetSFcnParam(S,3)
#define DTR_ARG                 ssGetSFcnParam(S,4)
#define COUNT_ARG               ssGetSFcnParam(S,5)
