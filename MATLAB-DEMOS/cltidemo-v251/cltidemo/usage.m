%----------------------------------------------------------------------------
%Using the CLTIDemo Graphical User Interface
%----------------------------------------------------------------------------
%
%----------------------------------------------------------------------------
%Overview
...
%Theory
%----------------------------------------------------------------------------
%The general form for the input (continuous-time) sinusoid is:
%
%     Input = A + B*cos(2*pi*f0*t + phi)
%
%where
%
%       A = DC Level
...
%
%     Output = A*D + B*M*cos(2*pi*f0*t + phi + P)
%
%where
% 
