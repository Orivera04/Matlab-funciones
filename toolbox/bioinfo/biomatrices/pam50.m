function [matrix, matrixInfo] = pam50
...
%
%   [MATRIX,MATRIXINFO] = PAM50 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'PAM50';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 2.00 ;
    matrixInfo.ExpectedScore = -3.70;
    matrixInfo.LowestScore = -13;
