...
if strcmp(action,'initialize'),
    ...
    figNumber=figure( ...
        'Name','Visibility-Based Coverage Animation', ...
        'NumberTitle','off', ...
        'Visible','off');
    axes( ...
        'Units','normalized', ...
...
elseif strcmp(action,'start'),
    ...
    elev = 10;  % Visibility threshold angle (deg)
    %======================================================
    ...
    set(h1,'String', 'Visibility threshold angle (deg) = ');
    set(h2,'String', sprintf('%.1f',elev));
    ...
    while (get(axHndl,'Userdata')==play)
      ...
      [elonv,nlatv] = perimvis(XECF{1}(index,:),elev,100);
      %======================================================
