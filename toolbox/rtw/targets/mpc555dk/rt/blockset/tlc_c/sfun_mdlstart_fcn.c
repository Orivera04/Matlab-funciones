/*
 * File: sfun_mdlstart_fcn.c
 *
 * Abstract:
 *   
 *
 * $Revision: 1.3.4.3 $
 * $Date: 2004/04/19 01:30:18 $
 *
...
#define S_FUNCTION_NAME sfun_mdlstart_fcn
...
//#define P_N_ELSEIF        ((int)mxGetScalar(ssGetSFcnParam(S,0)))
//#define P_ELSE            ((int)mxGetScalar(ssGetSFcnParam(S,1)))
