echo on; clc;
%---------------------------------------------------------------------------
%A9_8   MATLAB script file for implementing Algorithm 9.8
%
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%
% This program implements Hamming's method
%
...
diary  f.m; disp('function z = f(t,y)');...
            disp('z = 30 - 5*y;');...
diary off;
f(0,0); % Remark.  f.m rk4.m hamming.m are usd for Algorithm 9.8
pause  % Press any key to continue.
...
% - - - - - - - - - - - - - - - - - - - - - - - - -
%
% Example for figure 9.13(c), page 471.  
% Use Hamming's method
...
xlabel('t');
ylabel('y');
Mx1 = 'Hamming`s solution to y` = f(t,y).';
title(Mx1);
grid;
hold off;
...
%............................................
Mx2 = '     t(k)               y(k)';
Mx3 = 'Hamming`s method is stable';
...
diary off, echo on
pause % Press any key to perform the Hamming method.
...
xlabel('t');
ylabel('y');
Mx1 = 'An unstable Hamming solution to y` = f(t,y).';
title(Mx1);
grid;
hold off;
figure(gcf); pause % Press any key to continue.
...
% the results to the Matlab textfile   output
%............................................
Mx3 = 'Hamming`s method is unstable';
Mx4 = ['for  n = ',num2str(n),'  and  h = '];
Mx5 = [Mx4,num2str(h),' because'];
Mx6 = '     0.69/|f (t,y)| < h';
Mx7 = '            y';
