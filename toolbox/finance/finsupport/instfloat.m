function varargout = instfloat(varargin)
% INSTFLOAT constructor for the 'Type','Float' instrument.
%
%   To create a new instrument variable from data arrays:
%   ISet = instfloat(Spread, Settle, Maturity, Reset, Basis, Principal)
%
%   To add 'Float' instruments to an instrument variable:
%   ISet = instfloat(ISet, Spread, Settle, Maturity, Reset, Basis, Principal)
%
%   To list field meta-data for the 'Float' instrument:
...
%     Type "[FieldList, ClassList] = instfloat" to see the classes.  Dates
...
%     TypeString = 'Float'.
%
%   See also INSTBOND, INSTCAP, INSTSWAP, INSTADDFIELD, INSTDISP, INTENVPRICE, 
%            HJMPRICE.

%   Author(s): M. Reyes-Kattar 04/25/99
%   Copyright 1995-2002 The MathWorks, Inc. 
%   $Revision: 1.13 $  $Date: 2002/04/14 21:41:17 $
