/*
 *  IIR_DF2T_RC_RT.C - DSP filter runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:46:21 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF2T_RC(const real32_T          *u,
                       creal32_T               *y,
