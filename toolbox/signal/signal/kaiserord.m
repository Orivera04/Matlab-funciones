function [N, Wn, bta, filtype] = kaiserord(fcuts, mags, devs, fsamp, cellflag)
...
%   normalized frequency band edges Wn, Kaiser window beta parameter BTA  and
%   filter type FILTYPE to be used by the FIR1 function:
...
%   $Revision: 1.10.4.3 $  $Date: 2004/04/13 00:18:05 $
