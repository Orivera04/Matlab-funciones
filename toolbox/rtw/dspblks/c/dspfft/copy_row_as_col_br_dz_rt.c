/*
 *  copy_row_as_col_br_dz_rt.c - Signal Processing Blockset run-time library.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.1.6.1 $  $Date: 2003/12/06 15:55:16 $
 */
    ...
    )
{
    ...
    for (i=0; i<nCols-1; i++) {
        ...
        y[j].im = 0.0; /* Copy element into bit-rev position */
        {
            int_T bit = nCols;
            do {
                bit>>=1;
...
/* [EOF] copy_row_as_col_br_dz_rt.c */
