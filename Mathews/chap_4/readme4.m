...
3. The textbook discusses the following algorithm:
    ...
    Investigation of Taylor polynomial approximations.
    Pn(x) = c(1) + c(2)x + c(2)x^2 + ... + c(n+1)x^n

    To run the example for Algorithm 4.1 the user needs to use the script file 
    named a4_1.m.  This is accomplished by executing the Matlab command:

    a4_1 

4. The Matlab script in  a4_1.m  is self contained.
