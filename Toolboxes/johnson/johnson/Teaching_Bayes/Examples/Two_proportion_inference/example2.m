...
% using discrete testing prior [Albert (1996), p 82].

% Suppose that P1 and P2 are the two proportions of
% interest.  Each proportion can be the values 0, .1, ...
% 1 and the prior is the "testing" type which places
% a probability of .5 on the diagonal values p1=p2
...
type='t';            % type of prior is testing type
