function [mag,phase,freq]=psbfft_scope(sig_struct,freq_fund,freq_max,nb_cycles,no_input,no_sig)
...
if nargs ==5  | nargs==6,
   ...
   error('The psbfft_scope function must have 5 or 6 input arguments')
end
t=sig_struct.time;
if isempty(t)
	error(['The input variable ''',inputname(1),''' must be a structure with time'])
