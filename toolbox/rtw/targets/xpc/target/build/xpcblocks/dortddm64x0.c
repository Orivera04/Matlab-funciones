/* $Revision: 1.3 $ $Date: 2002/03/25 04:08:10 $ */
/* dortddm64x0.c - xPC Target, non-inlined S-function driver for DIO section of RTD DM64x0 board  */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#define 	S_FUNCTION_LEVEL 	2
#undef 		S_FUNCTION_NAME
#define 	S_FUNCTION_NAME 	dortddm64x0
...
static void mdlStart(SimStruct *S)
{
	...
	if (port==0) {
		...
		// write directions
		rl32eOutpB(BaseAddress+28, 0xff);
		...
		// write direction
		rl32eOutpB(BaseAddress+30, tmp | 0x04);

	}

	rl32eOutpB(BaseAddress+24+port*2, 0x00);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	rl32eOutpB(BaseAddress+24+port*2,tmp);
