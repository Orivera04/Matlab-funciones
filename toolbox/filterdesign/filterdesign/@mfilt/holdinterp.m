function Hm = holdinterp(varargin)
...
%
%   See also MFILT/LINEARINTERP, MFILT/FIRINTERP, MFILT/FIRFRACINTERP,
%   MFILT/CICINTERP, MFILT/CICINTERPZEROLAT.

%   Author: V. Pellissier
%   Copyright 1999-2002 The MathWorks, Inc.
%   $Revision: 1.2 $  $Date: 2002/10/30 20:50:19 $

Hm = mfilt.holdinterp(varargin{:});
