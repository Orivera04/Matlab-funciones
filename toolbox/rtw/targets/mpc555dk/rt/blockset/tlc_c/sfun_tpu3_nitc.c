/*
  * File: sfun_tpu3_nitc.c
  *
  * Abstract:
  *    S-function to implement TPU3 device driver
  *    for New Input Capture / Input Transition Counter 
  *
  * Disclaimers / restrictions if any.
  *
  * $Revision: 1.2.4.4 $
  * $Date: 2004/04/19 01:30:29 $
  *
...
#define S_FUNCTION_NAME  sfun_tpu3_nitc
...
#define P_TRANSITION_TYPE_REF    P_REF_UINT8(TRANSITION_TYPE)
#define P_MAX_COUNT_REF          P_REF_UINT16(MAX_COUNT)
#define P_CAPTURE_TYPE_REF       P_REF_UINT8(CAPTURE_TYPE)
#define P_PARAMETER_LOCATION_REF P_REF_UINT8(PARAMETER_LOCATION)
#define P_CAPTURE_CHANNEL_REF    P_REF_UINT8(CAPTURE_CHANNEL)
#define P_CAPTURE_PARAM_REF      P_REF_UINT8(CAPTURE_PARAM)
#define P_TRANS_COUNT_REF        P_REF_UINT8(TRANS_COUNT)
#define P_LAST_TRANS_TIME_REF    P_REF_UINT8(LAST_TRANS_TIME)
#define P_FINAL_TRANS_TIME_REF   P_REF_UINT8(FINAL_TRANS_TIME)
...
#define MODULE_STR_LEN 2
    ...
    char capture_param_alias[80];

    mxGetString(ssGetSFcnParam(S,MODULE),module,MODULE_STR_LEN);
    mxGetString(ssGetSFcnParam(S,CAPTURE_PARAM_ALIAS), capture_param_alias, 80);

    ssWriteRTWParamSettings(S, 13,
                            ...
                            SSWRITE_VALUE_DTYPE_NUM,
                            "ParameterLocation",
                            P_PARAMETER_LOCATION_REF,
                            DTINFO(SS_UINT8,0),

                            SSWRITE_VALUE_DTYPE_NUM,
                            "CaptureChannel",
                            P_CAPTURE_CHANNEL_REF,
                            DTINFO(SS_UINT8,0),
                            ...
                            SSWRITE_VALUE_DTYPE_NUM,
                            "LastTransTime",
                            P_LAST_TRANS_TIME_REF,
                            DTINFO(SS_UINT8,0),

                            SSWRITE_VALUE_DTYPE_NUM,
                            "FinalTransTime",
                            P_FINAL_TRANS_TIME_REF,
                            DTINFO(SS_UINT8,0)
