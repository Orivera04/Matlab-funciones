...
int rl32eGetPCIInfoExt( unsigned short vendor_id, 
...
int rl32eGetPCIInfoAtSlotExt(unsigned short vendor_id, unsigned short device_id, unsigned short sub_vendor_id, unsigned short sub_device_id, int slot, PCIDeviceInfo *pciinfo)
{
    int i;
    unsigned short vendid, devid, subvendid, subdevid;
