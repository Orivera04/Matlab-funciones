function dVt = psbregulzero(vFf,Ai,Bi,Idf,IFf,Iqf); % dVt = 1-Vt
% Prerequisite for computing the steady states of the generator.
%
% Data: the coefficients of the plant A, c, a, g11,g31, and wf = 1 (speed
% in st. st.) and df = given (delta in st. st.), all in datagen.m.
%
