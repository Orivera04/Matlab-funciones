/* $Revision: 1.4 $ $Date: 2002/03/25 04:08:02 $*/
/* donipctio10.c - xPC Target, non-inlined S-function driver for digital output section of NI PC-TIO-10 board */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME 		donipctio10
...
static void mdlInitializeConditions(real_T *x0, SimStruct *S)
{
    ...
    if (port==1) {
		...
		rl32eOutpB((unsigned short)(base_addr+0x5),0x0);			// PIA A control
		rl32eOutpB((unsigned short)(base_addr+0x4),0xff);			// PIA A direction
		rl32eOutpB((unsigned short)(base_addr+0x5),0x4);			// PIA A control
		rl32eOutpB((unsigned short)(base_addr+0x4),0x0);			// PIA A direction
	} else if (port==2) {
		ssSetIWorkValue(S,OUTPORT_I_IND , 0x6);
		rl32eOutpB((unsigned short)(base_addr+0x7),0x0);			// PIA B control
		rl32eOutpB((unsigned short)(base_addr+0x6),0xff);			// PIA B direction
		rl32eOutpB((unsigned short)(base_addr+0x7),0x4);			// PIA B control
		rl32eOutpB((unsigned short)(base_addr+0x6),0x0);			// PIA B direction
 	}
...
static void mdlOutputs(real_T *y, const real_T *x, const real_T *u, SimStruct *S, int_T tid)
{
    ...
    rl32eOutpB((unsigned short)(base_addr+port),(unsigned short)output);
...
{   
    ...
    rl32eOutpB((unsigned short)(base_addr+port),0x0);
