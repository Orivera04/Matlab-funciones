 ...
 *          bipolar (+1/-1) format.
 *      Both outputs are 2D frame-signals.
 *
 *  Parameters:
 *      Output Frame Size	
 ...
 *  $Revision: 1.3 $  $Date: 2002/04/14 16:32:44 $
 */
#define S_FUNCTION_NAME sis95scgen2
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    for (i= 0; i<2; i++){
        ssSetOutputPortFrameData(           S, i, FRAME_YES);
        if(!ssSetOutputPortMatrixDimensions(S, i, numSymb, 1)) return;
    }
