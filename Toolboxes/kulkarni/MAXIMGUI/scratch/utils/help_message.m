...
%      'Windowstyle','modal');
   ...
   uicontrol('Parent',fig, ...
      'Units','points', ...
      'Callback','help_message(''multiple_back'')' ,...
      'FontName','time roman', ...
      'FontSize',Scale*14, ...
   ...
   uicontrol('Parent',fig, ...
      ...
      'FontName','time roman', ...
      'FontSize',Scale*14, ...
      'Position',Scale*[235 20 60 30], ...
      'String','RETURN', ...
      'Tag','OK button');
   % (UserData holds the current frame number)
   uicontrol('Parent',fig, ...
      'Units','points', ...
      'Callback','help_message(''multiple_next'')' ,...
      'FontName','time roman', ...
      'FontSize',Scale*14, ...
      'Position',Scale*[295 20 30 30], ...
      'String','>', ...
      'Tag','> button', ...
      'Visible','off');
