...
%MATQPARSE Obsolete function.
%   MATQPARSE function is obsolete and may be removed from future versions.
%
%   See also SAVE, LOAD, PERSISTENT

warning('UITools:ObsoleteFunction:matqparse', 'MATQPARSE function is obsolete.');
...
%  $Revision: 1.15.4.1 $  $Date: 2002/10/24 02:13:35 $
