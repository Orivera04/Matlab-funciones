/*
 *  poly2lsfr_d_rt.c - Poly2Lsf block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:47:30 $
 */

#include "dsppoly2lsp_rt.h"

EXPORT_FCN int_T MWDSP_Poly2Lsfr_D(
