/*
 * File: c166_can_reset.c
 *
 * Abstract:
 *   Generate code that resets the CAN module.
 *   
 *
 * $Revision: 1.1.6.2 $
 * $Date: 2004/04/19 01:17:27 $
 *
...
#define S_FUNCTION_NAME c166_can_reset
...
/* P2 */
#define P_SAMPLE_TIME  ssGetSFcnParam(S,1)
