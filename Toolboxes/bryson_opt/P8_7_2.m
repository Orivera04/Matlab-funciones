% Script p8_7_2.m; min distance to ellipse w. b=1, a=2;    7/98, 7/23/02
%
...
%
figure(1); clf; plot(1.5,0,'ro',xe,ye,'b',xe,-ye,'b',[1.5 2],[0 0],'b'); 
hold on; for i=1:N+1, plot([x(i) xf(i)],[0,yf(i)],'b',[x(i) xf(i)],...
      [0 -yf(i)],'b'); end 
for j=1:5, plot(xt(:,j),yt(:,j),'r--',xt(:,j),-yt(:,j),'r--'); end
