function varargout = dspblkupsamp2(action,varargin)
% DSPBLKUPSAMP2 Signal Processing Blockset Upsample block helper function.

% Copyright 1995-2003 The MathWorks, Inc.
% $Revision: 1.4.4.2 $ $Date: 2004/04/12 23:07:36 $
...
case 'icon'
   ...
   x = [0 NaN 1 NaN .3 .3 NaN .2 .3 NaN .4 .3];
   y = [0 NaN 1 NaN .2 .8 NaN .6 .8 NaN .6 .8];
