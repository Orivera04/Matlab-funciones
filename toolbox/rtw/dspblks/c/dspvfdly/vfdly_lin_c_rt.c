/*
 *  vfdly_lin_c_rt Run-time function for Variable Fractional Delay block.
 *
 *  This function implements the case of Linear interpolation mode, 
 *  Date-type is :- single-precision, complex 
 * 
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:49:43 $
 *
 */
