...
%   time.
%
%   See also ODE15I, BURGERSODE, ODESET, @.

%   Jacek Kierzenka and Lawrence F. Shampine
%   Copyright 1984-2003 The MathWorks, Inc.
%   $Revision: 1.1.6.3 $  $Date: 2004/04/10 23:24:55 $
...
[y0,yp0,resnrm] = decic(@Fimpl,tspan(1),y0,[],yp0,[],opts,N);

[t,y] = ode15i(@Fimpl,tspan,y0,yp0,opts,N);
...
[t,y] = ode15i(@Fimpl,[tspan(1) tspan(end)],y0,yp0,opts,N);
...
function res = Fimpl(t,y,yp,N)
res = mass(t,y,N)*yp - f(t,y,N);

% --------------------------------------------------------------------------   

function [dfdy,dfdyp] = Jac(t,y,yp,N)
dfdy = [];
dfdyp = mass(t,y,N);
