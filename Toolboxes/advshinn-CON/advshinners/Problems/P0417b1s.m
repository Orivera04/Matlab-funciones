function [ret,x0,str]=P0417B1S(t,x,u,flag);
%P0417B1S       is the M-file description of the SIMULINK system named P0417B1S.
%       The block-diagram can be displayed by typing: P0417B1S.
%
%       SYS=P0417B1S(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%       Setting FLAG=1 causes P0417B1S to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%       Calling P0417B1S with a FLAG of zero:
%       [SIZES]=P0417B1S([],[],[],0),  returns a vector, SIZES, which
