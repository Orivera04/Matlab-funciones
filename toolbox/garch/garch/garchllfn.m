function [LLF, G, H, e, h, LogLikelihoods] = garchllfn(Parameters, y, R, M, P, Q, X, isConstantInMean, isVarianceInMean, e0, s0, y0)
%GARCHLLFN Univariate GARCH process objective function (Gaussian Distribution).
...
%   conditional variances are then fit to a GARCH model. Gaussian innovations
%   are assumed.
%
%   [LLF, G, H, Innovations, Sigmas, LogLikelihoods] = garchllfn(Parameters, 
...
%   $Revision: 1.11.4.1 $   $Date: 2003/05/08 21:45:25 $
...
varianceCoefficients  =  Parameters((isConstantInMean + R + M + nX + isVarianceInMean + 1):end);
