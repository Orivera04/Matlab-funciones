...
%  $Revision: 1.2.2.3 $  $Date: 2004/02/09 07:14:49 $

% Resets the cgnormfunction to the version stored in version I in the memory field.
...
if ok
    ...
    N.Memory{n+1}.Information = 'Reset from history viewer';
    N.Memory{n+1}.Data = [];
