% Script e04_6_2.m; DTDP for min tf to vf=0 & spec. (uf,yf) using DOPTF;
% (u,v) in uf, (x,y) in uf^2/a, t in uf/a;                 3/97, 6/25/02  		    
%
la0=[-.3863 -.9257 -1.2434  0]'; th0=1.1366; N=10; s0=[0 0 0 0]';
tf=1.4890; nu=[-.3863 .9257 -1.2434]'; p0=[la0' nu' tf];
name='dtdpt'; optn=optimset('Display','Off','MaxIter',500);
p=fsolve('doptf',p0,optn,name,th0,s0,N);
[f,s,th,la]=doptf(p,name,th0,s0,N); t=tf*[0:1/N:1]; u=s(1,:);
v=s(2,:); y=s(3,:); x=s(4,:); thh=[th th(N)];
%
