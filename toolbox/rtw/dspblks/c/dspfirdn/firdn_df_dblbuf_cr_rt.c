/*
 *  firdn_df_dblbuf_cr_rt.c - FIR Decimation block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:44:57 $
 *
...
EXPORT_FCN void MWDSP_FIRDn_DF_DblBuf_CR(
    const creal32_T   *u,
          creal32_T   *yout,
          creal32_T   *tap0,
          creal32_T   *sums,
