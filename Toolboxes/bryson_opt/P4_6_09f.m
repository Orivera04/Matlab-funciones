% Script p4_6_09f.m; DTDP for min tf with gravity to vf=0 and  spec. 
% (uf,yf) with DOPTF;	                               3/97, 3/28/02
%
clear; clear global; global yf g; yf=.2/.4935^2; g=1/3; 
N=10; la0=[-.2567 -1.4719 -1.0796 0]; tf=2.0299;
nu=[-.2567 .7197 -1.0796]; s0=[0 0 0 0]'; name='dtdpgt';
optn=optimset('Display','Iter','MaxIter',5); p0=[la0 nu tf]; u0=1;
p=fsolve('doptf',p0,optn,name,u0,s0,N);
[f,s,th,la]=doptf(p,name,u0,s0,N); tf=p(8); thh=[th th(N)]*180/pi;
