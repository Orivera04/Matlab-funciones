...
%
% *** If you change this table, change same in watchsigsdlg.m ***
% 
...
set(textExtent, 'String', 'Scroll ');
ext = get(textExtent, 'Extent');
geom.scrollCheckboxWidth = ext(3) + sysOffsets.checkbox(3);

set(textExtent, 'String', 'Show data markers');
ext = get(textExtent, 'Extent');
...
function ctrlPos = i_PerformanceCtrlPositions(commonGeom, dataGeom),
  ...
  set(textExtent,'String','Refresh period (frames): ');
  ext = get(textExtent, 'Extent');
  ...
  set(commonGeom.textExtent,'String','Freeze graphics  ');
...
% Function =====================================================================
% Return the state of the 'Show Data Markers' checkbox.
...
allChildren = [generalCellchildren{:}];
