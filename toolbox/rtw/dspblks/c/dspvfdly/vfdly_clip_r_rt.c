/*
 *  vfdly_clip_r_rt Helper function for Variable Fractional Delay block.
 *
 *  Copyright 1995-2002 The MathWorks, Inc.
 *  $Revision: 1.2 $  $Date: 2002/04/14 19:19:20 $
 *
...
int_T MWDSP_Vfdly_Clip_R(
    const int_T maxDelay, 
    real32_T *delay_point
    )
{
    if (*delay_point < 0) {
        *delay_point = 0.0F;
    } else if (*delay_point > maxDelay) {
        *delay_point = (real32_T)maxDelay;
    }
