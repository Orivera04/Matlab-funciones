 ...
 *      GRAY = rjpgc(filename); 
 * 
 * GRAY is a mxn uint16 array containing the 16-bit grayscale image
 ...
 * $Revision: 1.1.6.1 $  $Date: 2003/12/13 03:01:21 $
 */

static char rcsid[] = "$Id: rjpg16c.c,v 1.1.6.1 2003/12/13 03:01:21 batserve Exp $";
 ...
 */
  ...
  {
      mexErrMsgTxt("16-bit images must be grayscale.");
  }
