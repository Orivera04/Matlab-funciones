function [ret,x0,str]=F0414S(t,x,u,flag);
%F0414S is the M-file description of the SIMULINK system named F0414S.
%       The block-diagram can be displayed by typing: F0414S.
%
%       SYS=F0414S(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%       Setting FLAG=1 causes F0414S to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%       Calling F0414S with a FLAG of zero:
%       [SIZES]=F0414S([],[],[],0),  returns a vector, SIZES, which
...
simver(1.2)
if(0 == (nargin + nargout))
     set_param(sys,'Location',[23,105,403,212])
     open_system(sys)
end;
...
add_line(sys,[50,40;100,40])
add_line(sys,[145,40;185,40])
add_line(sys,[230,40;280,40])
