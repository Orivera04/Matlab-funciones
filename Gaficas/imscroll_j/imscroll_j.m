...
hSliders = getappdata(hAxes,'SliderAxes');      % Retrive the slider handles
if (isempty(hSliders))                          % No sliders, go away.
    return;
end
