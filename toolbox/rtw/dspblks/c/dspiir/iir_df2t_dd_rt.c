/*
 *  IIR_DF2T_DD_RT.C - DSP filter runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:46:19 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF2T_DD(const real_T               *u,
                       real_T               *y,
