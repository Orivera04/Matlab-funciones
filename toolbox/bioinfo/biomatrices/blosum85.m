function [matrix, matrixInfo]  = blosum85
%BLOSUM85 Clustered Scoring Matrix in 1/2 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 85
%   Entropy =   1.0805, Expected Score =  -0.8153
%   Lowest Score = -6, Highest Score = 11
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM85 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM85';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 1.0805;
    matrixInfo.ExpectedScore =  -0.8153;
