/*
 *  ALLPOLE_DF_DZ_A0SCALE_RT.C - DSP Allpole DF filter runtime helper function.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:40:47 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_AllPole_DF_A0Scale_DZ( 
                       const real_T         *u,
                       creal_T              *y,
