% POWER_CIRC2SS.M script file
% This file illustrates the use of the POWER_STATESPACE command.
% The old name for this command is CIRC2SS.  The old name still works.
%
% POWER_CIRC2SS creates the parameters for the circuit used in the 
%            example section of the POWER_STATESPACE documentation and 
%            calls the POWER_STATESPACE command to produce the state-space model.
%
...
%
% See POWER_STATESPACE documentation for details
%
% The variables returned by the POWER_STATESPACE command are:
...
% open file which will contain POWER_STATESPACE output information
