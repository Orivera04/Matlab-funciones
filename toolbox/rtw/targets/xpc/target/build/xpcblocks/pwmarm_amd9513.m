function [MasterMode, CounterMode, Init, Runtime, Term]= ...
  pwmarm_amd9513(counter, freq_base, freq, initduty, togglestart, init_arm);

% PWMARM_AMD9513 - Mask Initialization function for PWM and ARM functionality of AMD9513 based I/O-driver blocks

% Copyright 1996-2003 The MathWorks, Inc.
% $Revision: 1.5.4.1 $ $Date: 2004/04/08 21:03:17 $

if togglestart==1
  initduty= 1-initduty;
end
relDuration= 1/freq;
initLoad= initduty*relDuration;
