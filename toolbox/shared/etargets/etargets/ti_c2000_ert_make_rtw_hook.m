function ti_c2000_ert_make_rtw_hook (hookPoint, modelName, rtwroot, tmf, buildOpts, buildArgs)
% TI_C2000_ERT_MAKE_RTW_HOOK - TI C2000 Target 
%            hook file for the build process (make_rtw).

% $RCSfile: ti_c2000_ert_make_rtw_hook.m,v $
% $Revision: 1.1.6.2 $ $Date: 2004/04/08 21:08:15 $
...
% [EOF] ti_c2000_ert_make_rtw_hook.m
