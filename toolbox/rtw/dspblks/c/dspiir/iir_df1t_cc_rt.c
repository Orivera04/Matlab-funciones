/*
 *  IIR_DF1T_CC_RT.C - DSP filter runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.2 $  $Date: 2004/04/12 23:45:45 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF1T_CC( const creal32_T          *u,
                         creal32_T               *y,
