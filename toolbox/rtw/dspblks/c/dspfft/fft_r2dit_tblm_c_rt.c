/*
 * fft_r2dit_tblm_c_rt.c - Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.6.2.3 $  $Date: 2004/04/12 23:43:44 $
 */

#include "dspfft_rt.h"

EXPORT_FCN void MWDSP_R2DIT_TBLM_C(
    creal32_T      *y,
    int_T           nChans,
    const int_T     nRows,
    const int_T     fftLen,
