function obj = removeRectFromExtrapolationMask(obj, varargin)
%REMOVERECTFROMEXTRAPOLATIONMASK Remove a rectangular region from the extrapolation mask
%
%  OBJ = REMOVERECTFROMEXTRAPOLATIONMASK(OBJ, ROWRANGE, COLRANGE) removes
%  rectangular regions from the extrapolation mask. ROWRANGE and COLRANGE
...
%  from the mask.
%
%  OBJ = REMOVERECTFROMEXTRAPOLATIONMASK(OBJ, ROWRANGE) removes linear
%  regions from the mask of a 1D table.
%
%  OBJ = REMOVERECTFROMEXTRAPOLATIONMASK( ...
...
%
%  SEE ALSO:  CGLOOKUP/ADDRECTTOEXTRAPOLATIONMASK.

%  Copyright 2000-2004 The MathWorks, Inc. and Ford Global Technologies, Inc.

%  $Revision: 1.1.6.2 $    $Date: 2004/02/09 07:12:07 $ 
