/* 
   disbsdig24.c - xPC Target, non-inlined S-function driver for the
   digital input section of SBS IP-Digital-24 IP modules
...
#define  S_FUNCTION_NAME  disbsdig24
...
static int_T regNum[NUM_CHANS / 8] = {0, 0, 1};
static int_T output[NUM_REGS] = {0x00, 0x01};
static int_T input[NUM_REGS]  = {0x02, 0x03};
