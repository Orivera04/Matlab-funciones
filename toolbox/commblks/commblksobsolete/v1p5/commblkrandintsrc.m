function varargout = commblkrandintsrc(block, varargin)
% COMMBLKRANDINTSRC Mask dynamic dialog function for random integer source block

% Author: Trefor Delve
% Copyright 1996-2002 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2003/01/26 18:44:38 $
...
if(strcmp(action,'UpdateWs'))
   [varargout{1:2}]=srcsicon(4); % Mask icon
end;
