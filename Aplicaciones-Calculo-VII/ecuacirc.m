%Programa que encuentra la ecuación de una circunferencia dado el centro
...
%disp('La ecuación de la cicunferencia es: ');
ecua= char(ecuacion);
fprintf('La ecuación de la cicunferencia es:%s  ',ecua),
disp('= 0');
