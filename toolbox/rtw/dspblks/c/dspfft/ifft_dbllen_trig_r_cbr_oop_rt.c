/*
 * ifft_dbllen_trig_r_cbr_oop_rt.c- Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.4.2.3 $  $Date: 2004/04/12 23:44:14 $
 */
 ...
 *
 */
EXPORT_FCN void MWDSP_Ifft_DblLen_TRIG_R_Cbr_Oop(
    creal32_T      *y,
    const real32_T *x,
    const int_T     fftLen
    )
...
/* [EOF] ifft_dbllen_trig_r_cbr_oop_rt.c */
