...
% This function creates data for a three mass system.
% The name of the function should be changed to specify
% different problems. However, the output variable list 
% should remain unchanged to retain compatibility with
