function varargout = commblkgmskdemod(block, action, varargin)
% COMMBLKGMSKDEMOD Mask dynamic dialog function for GMSK demodulator block
...
case 'init'
    ...
    maskpropupdate('CPM Demodulator Baseband','outputType');
