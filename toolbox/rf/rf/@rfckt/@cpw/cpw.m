...
%CPW Constructor.
%   H = RFCKT.CPW('PROPERTY1',VALUE1,'PROPERTY2',VALUE2,...) returns a
%   coplanar waveguide transmission line object, H, based on the specified
%   properties. The properties include,
% 
%             Name: 'Coplanar Waveguide Transmission Line' (read only)
%            nPort: 2 (read only)
...
%   $Revision: 1.1.6.5 $ $Date: 2004/04/20 23:19:36 $

h = rfckt.cpw;

% Set the values for the properties
set(h, varargin{:}, 'Name', 'Coplanar Waveguide Transmission Line');
