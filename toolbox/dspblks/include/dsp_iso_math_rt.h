 ...
 *  $Revision: 1.6 $  $Date: 2002/04/26 23:31:53 $
 */
 ...
 */
#define _SP_ISO_MATH_NOT_SUPPORTED_ (  defined(__STRICT_ANSI__) || ( (!defined(_ISOC_)) && (!defined(__USE_ISOC9X)) && (!defined(_ISOC9X_SOURCE)) && (!defined(__mathf__)) )  )


#if _SP_ISO_MATH_NOT_SUPPORTED_
...
#endif /* _SP_ISO_MATH_NOT_SUPPORTED_ */
