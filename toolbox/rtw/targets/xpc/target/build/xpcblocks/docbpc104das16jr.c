/* $Revision: 1.5 $ $Date: 2002/03/25 04:07:17 $ */
/* docbpc104das16jr.c - xPC Target, non-inlined S-function driver for digital output section of CB PC104-DAS16JR board */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME docbpc104das16jr
...
static void mdlInitializeConditions(real_T *x0, SimStruct *S)
{
		...
		rl32eOutpB((unsigned short)(base_addr+0x3),0x0);
...
static void mdlOutputs(real_T *y, const real_T *x, const real_T *u, SimStruct *S, int_T tid)
{
        ...
        rl32eOutpB((unsigned short)(base_addr+0x3),(unsigned short)output);
