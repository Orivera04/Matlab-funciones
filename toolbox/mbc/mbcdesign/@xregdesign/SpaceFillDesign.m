function [d,ok]=SpaceFillDesign(d,cs,action,opt)
% SPACEFILLDESIGN  interface for setting a space filling design
%
% D=SpaceFillDesign(D, CSET,[ACTION],[OPT]) sets the design to consist of
% the points in CandidateSet CSET, and marks the design as
% a classical design of the appropriate type.
%
...
%   $Revision: 1.2.2.2 $  $Date: 2004/02/09 07:06:06 $
...
if (tp~=1)
   error('Not a Space Filling Design Set Generator');
end
