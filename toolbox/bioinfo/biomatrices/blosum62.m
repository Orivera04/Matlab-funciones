function [matrix, matrixInfo]  = blosum62
...
%
%   [MATRIX,MATRIXINFO] = BLOSUM62 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM62';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 0.6979;
    matrixInfo.ExpectedScore =  -0.5209;
