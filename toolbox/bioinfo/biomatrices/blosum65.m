function [matrix, matrixInfo]  = blosum65
%BLOSUM65 Clustered Scoring Matrix in 1/2 Bit Units
%   Blocks Database = /data/blocks_5.0/blocks.dat
%   Cluster Percentage: >= 65
%   Entropy =   0.7576, Expected Score =  -0.5675
%   Lowest Score = -5, Highest Score = 10
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = BLOSUM65 returns a structure of information about
...
if nargout >1
    matrixInfo.Name = 'BLOSUM65';
    matrixInfo.Scale = 1/2;
    matrixInfo.Entropy = 0.7576;
    matrixInfo.ExpectedScore =  -0.5675;
    matrixInfo.HighestScore = 10;
