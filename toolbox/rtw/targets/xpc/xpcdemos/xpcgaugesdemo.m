...
%
%   To run the demo  gauges model xpctankpanel together with the
...
%   model xpctankpanel. These are the key to interfacing gauges to
...
%   $Revision: 1.1.4.1 $ $Date: 2004/04/08 21:05:31 $
