function [convBaseAddr, SampleTime, SampleOffset] = mdaadcvpcl818 (flag, boardType, Channels, Range, Sample, BaseAddr)

% MDAADVPCL818 - InitFcn and Mask Initialization for Advantech PCL-818 family D/A section

% Copyright 1996-2002 The MathWorks, Inc.
% $Revision: 1.3 $ $Date: 2002/03/25 04:08:55 $
...
case 10
   ...
   description='PCL-726';
   RangeElements = [10, 5, -10, -5, 20];
   RangeStr='10, 5, -10, -5, 20';
case 11
   MAX_CHANNEL=12;
   chnDisplay='disp(''PCL-727\nAdvantech\n';
   description='PCL-727';
   RangeElements = [10, 5, -5, 20];
   RangeStr='10, 5, -5, 20';
case 12
   MAX_CHANNEL=2;
   chnDisplay='disp(''PCL-728\nAdvantech\n';
   description='PCL-728';
   RangeElements = [10, 5, -10, -5, 20];
   RangeStr='10, 5, -10, -5, 20';
end
