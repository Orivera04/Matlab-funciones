...
%       points P1 and P2.
%   
%   L = CREATELINE(X0, Y0, Z0, DX, DY, DZ) the line going through point 
%       [x0, y0, z0] and with direction vector [DX DY DZ].
%
%   L = CREATELINE(P0, DX, DY, DZ) the line going through point P0 given by 
%       [x0, y0, z0] and with direction vector [DX DY DZ].
%
%   
%   L = CREATELINE(THETA, PHI) create a line originated at (0,0) and
%       with angles theta and phi.
%
%   L = CREATELINE(P0, THETA, PHI) create a line with direction given by
%       theta and phi, and which contains point P0.
%
%
