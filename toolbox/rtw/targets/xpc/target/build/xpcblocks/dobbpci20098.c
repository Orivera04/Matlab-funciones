/* $Revision: 1.4 $ $Date: 2002/03/25 04:04:09 $ */
/* dobbpci20098.c - xPC Target, non-inlined S-function driver for digital output section of BB PCI-20098 board  */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME dobbpci20098
...
static void mdlInitializeConditions(real_T *x0, SimStruct *S)
{
        ...
        switch (port) {
            case 1: 
               ...
               pci20098PortA=2; // set it to output
               control=0x82;
               if (pci20098PortB==2) {
            ...
            case 2:
               ...
               pci20098PortB=2; // set it to output
               control=0x90;
               if (pci20098PortA==2) {
