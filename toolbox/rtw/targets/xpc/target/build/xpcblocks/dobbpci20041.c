/* $Revision: 1.5 $ $Date: 2002/03/25 04:04:06 $ */
/* dobbpci20041.c - xPC Target, non-inlined S-function driver for digital output section of BB PCI-20041 board  */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME dobbpci20041
...
static void mdlInitializeConditions(real_T *x0, SimStruct *S)
{
        ...
        mxGetString(BASE_ADDR_ARG, arg_str, arg_str_len);
        ...
        switch (port) {
            case 0: 
               pci20041digout=pci20041digout & 0x8e;
               ioaddress[0x8]=0x0;
               ioaddress[0x0]=pci20041digout;
               ssSetIWorkValue(S,OUTPORT_I_IND , 0x8);
               break;
            case 1:
               pci20041digout=pci20041digout & 0x8d;
               ioaddress[0x9]=0x0;
               ioaddress[0x0]=pci20041digout;
               ssSetIWorkValue(S,OUTPORT_I_IND , 0x9);
               break;
            case 2:
               pci20041digout=pci20041digout & 0x8b;
               ioaddress[0xa]=0x0;
               ioaddress[0x0]=pci20041digout;
               ssSetIWorkValue(S,OUTPORT_I_IND , 0xa);
               break;
            case 3:
               pci20041digout=pci20041digout & 0x87;
               ioaddress[0xb]=0x0;
               ioaddress[0x0]=pci20041digout;
