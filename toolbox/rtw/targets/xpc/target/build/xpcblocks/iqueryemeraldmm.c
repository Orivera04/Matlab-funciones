/* $Revision: 1.1.6.2 $ $Date: 2003/11/13 06:22:28 $ */
...
#define         S_FUNCTION_NAME         iqueryemeraldmm
...
#define INTSTAT_ARG             ssGetSFcnParam(S,4)
...
//printf("ISR entry\n");
    ...
    status = rl32eInpB( (unsigned short)(intstat) ) & 0xf;
