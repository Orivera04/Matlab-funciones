/*
 *  IIR_DF2T_CR_RT.C - DSP filter block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:46:18 $
 */
#include "dsp_rt.h"

EXPORT_FCN void MWDSP_IIR_DF2T_CR(const creal32_T         *u,
                       creal32_T               *y,
