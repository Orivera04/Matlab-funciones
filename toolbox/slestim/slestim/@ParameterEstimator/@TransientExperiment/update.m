...
% $Revision: 1.1.6.5 $ $Date: 2004/04/11 00:43:15 $
...
this.InitialStates = LocalUpdateStates( this.InitialStates, this );
...
for ct = 1:length(new_Ports)
  hData = [ hData ; ParameterEstimator.TransientData( new_Ports{ct} ) ];
end
...
for ct = 1:length(new_Ports)
  ...
  hData = [ hData ; ParameterEstimator.TransientData( new_Ports{ct}, PortNo ) ];
end
