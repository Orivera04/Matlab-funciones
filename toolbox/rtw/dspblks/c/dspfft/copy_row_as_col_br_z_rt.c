/*
 *  copy_row_as_col_br_z_rt.c - Signal Processing Blockset run-time library.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.1.6.1 $  $Date: 2003/12/06 15:55:18 $
 */
 ...
 */
EXPORT_FCN void MWDSP_CopyRowAsColBR_Z(
    creal_T          *y,
    const creal_T    *x,
    const int_T       nCols,
    const int_T       nRows,
