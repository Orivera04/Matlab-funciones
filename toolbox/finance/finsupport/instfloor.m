function varargout = instfloor(varargin)
% INSTFLOOR constructor for the 'Type','Floor' instrument.
%
%   To create a new instrument variable from data arrays:
%   ISet = instfloor(Strike, Settle, Maturity, Reset, Basis, Principal)
%
%   To add 'Floor' instruments to an instrument variable:
%   ISet = instfloor(ISet, Strike, Settle, Maturity, Reset, Basis, Principal)
%
%   To list field meta-data for the 'Floor' instrument:
...
%     Type "[FieldList, ClassList] = instfloor" to see the classes.  Dates
...
%     TypeString = 'Floor'.
%
%   See also INSTBOND, INSTCAP, INSTSWAP, INSTADDFIELD, INSTDISP, 
%            INTENVPRICE, HJMPRICE.

%   Author(s): M. Reyes-Kattar 03/10/99
%   Copyright 1995-2002 The MathWorks, Inc. 
%   $Revision: 1.13 $    $Date: 2002/04/14 21:41:26 $
