...
%TBASE  Read TerrainBase Global 5-Min digital terrain data.
%
...
% limits must be two-element vectors in units of degrees. Longitude limits 
% can be defined in the range [-180 180] or [0 360]. For example,
...
% Download the file in binary mode. Don't swap the bytes or change line 
% endings.
%
% See also GTOPO30, ETOPO5, USGSDEM

%  Copyright 1996-2004 The MathWorks, Inc.
%  $Revision: 1.1.6.2 $ $Date: 2004/03/24 20:41:19 $
