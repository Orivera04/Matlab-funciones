function matrix = gonnet
%GONNET returns the PAM 250 matrix recommended by Gonnet, Cohen & Benner.
%
%   Reference:  Science June 5, 1992.
%   The values in the matrix are rounded to nearest integer.
%   The order is:
