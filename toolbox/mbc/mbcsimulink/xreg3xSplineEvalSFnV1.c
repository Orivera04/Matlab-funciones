...
#define S_FUNCTION_NAME  xreg3xSplineEvalSFnV1
...
static void mdlSetWorkWidths(SimStruct *S){
	int width0 = ssGetInputPortWidth(S,0);
	int width1 = ssGetInputPortWidth(S,1);
	ssSetNumRWork(S, width0+width1);
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	InputRealPtrsType coeffs = ssGetInputPortRealSignalPtrs(S,0);
	int numCoeffs = ssGetInputPortWidth(S,0);
	...
	/* Get a contiguous copy of the coefficents */
	c = tx;
