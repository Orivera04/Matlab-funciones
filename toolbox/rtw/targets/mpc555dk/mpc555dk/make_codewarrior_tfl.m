function hLib = make_codewarrior_tfl
%MAKE_CODEWARRIOR_TFL create an instance of the Target Function Library for Codewarrior
%   MAKE_CODEWARRIOR_TFL creates an instance of the Target Function Library for 
%   use with the Codewarrior compiler.
  
%   Copyright 2004 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $
%   $Date: 2004/04/08 20:58:19 $

  hLib = make_ansi_tfl;
  hLib.matFileName = 'codewarrior_tfl_tmw.mat';
  
  %% Unsupported functions in CodeWarrior inherited from make_ansi_tfl: trunc
