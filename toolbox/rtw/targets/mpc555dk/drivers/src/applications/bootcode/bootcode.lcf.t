...
Abstract : 
	Code Warrior Linker Command File

$Revision: 1.1.6.3 $
$Date: 2004/04/19 01:24:58 $
...
FORCEFILES \{ exception_table.o boot_bios.o \} 
...
SECTIONS \{
   ...
   GROUP : \{
      .exception_table : \{\}
      /* Boot bios should live at 0x104 which is the end of the exception_table */
      ...
      .text_init (TEXT) : \{ main.o(.text) __ppc_eabi_init.o(.text) memcpy.o(.text) memset.o(.text) boot_bios.o(.text)  \}
      .fini       : \{ \}
   \} > bootrom
