/* $Revision: 1.7 $ $Date: 2002/03/25 04:04:15 $ */
/* genixpci8255.c - xPC Target, non-inlined S-function driver for digital input/output section of PCI boards using the 8255 chip driving Genix */
...
#define         S_FUNCTION_NAME         genixpci8255
...
static void mdlStart(SimStruct *S)
{
    ...
    deviceId=0x28;
    sectionAddr=0x2;
    offset8255=(int_T)mxGetPr(BASE_8255_ARG)[0];
    ...
    base8255=pciinfo.BaseAddress[sectionAddr]+offset8255;
