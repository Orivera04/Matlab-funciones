...
%MCOV   Modified covariance spectral estimation.
%   H = SPECTRUM.MCOV instantiates a modified covariance (mcov) spectrum
%   object.
%
%   H = SPECTRUM.MCOV(ORDER) sets the order property to ORDER.
%
%   H = SPECTRUM.MCOV(ORDER,FFTLENGTH) sets the mode of specifying the
...
%      h = spectrum.mcov(4);                 % Instantiate a burg object.
%      psd(h,y,'Fs',1000);                   % Plot the PSD.
%
%   See also SPECTRUM/PSD, SPECTRUM/COV, SPECTRUM/BURG, SPECTRUM/YULEAR,
%   SPECTRUM/MTM, SPECTRUM/WELCH, SPECTRUM/PERIODOGRAM,
%   SPECTRUM/EIGENVECTOR, SPECTRUM/MUSIC.

%   Author(s): P. Pacheco
%   Copyright 1988-2004 The MathWorks, Inc.
%   $Revision: 1.1.6.5 $  $Date: 2004/04/13 00:18:26 $

% Help for constructing an mcov object.
