function [carrier, maskDisplay, maskDescription] = mdiosbsdig48(carrierId, carrierSlot, channel, sampleTime, direction, reset, initValue)

% mdiosbsdig48 - Mask Initialization for Digital I/O for SBS IP-Unidig-E-48
...
% Copyright 1996-2003 The MathWorks, Inc.
    ...
    maskDisplay = sprintf('disp(''IP-Unidig-E 48\\nSBS\\nDigital %s'');', direction);

    for i = 1:length(channel)
        maskDisplay = sprintf('%s port_label(''%s'', %i, ''%i'');', maskDisplay, portparam, i, channel(i));
    end         

    maskDescription = ['IP-Unidig-E 48' 10 'SBS' 10 'Digital ' direction];
