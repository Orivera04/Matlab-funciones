function varargout = commblkcpmmod(block, action, varargin)
% COMMBLKCPMMOD Mask dynamic dialog function for CPM modulator block
% Copyright 1996-2003 The MathWorks, Inc.
% $Revision: 1.10.4.2 $ $Date: 2004/04/12 23:02:50 $
...
case 'init'
    ...
    case 'Gaussian'
        if(~isscalar(maskBT) | ~isreal(maskBT) | (maskBT < 0))
            eStr.ecode = 1;
