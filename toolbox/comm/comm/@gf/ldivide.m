function z = ldivide(x,y,varargin)
%LDIVIDE Element-by-element quotient .\ of GF arrays.
%   A.\B denotes element-by-element division.  A and B
%   must have the same dimensions unless one is a scalar.
%   Division by the element 0 generates an error.

%    Copyright 1996-2002 The MathWorks, Inc.
%    $Revision: 1.3 $  $Date: 2002/03/27 00:15:40 $ 
...
z.x = gf_mex(x.x,x.x,x.m,'rdivide',x.prim_poly,...
                GF_TABLE1,GF_TABLE2);  % <-- element-wise multiplicitive inverse
z.x = gf_mex(y.x,z.x,x.m,'times',x.prim_poly,...
                GF_TABLE1,GF_TABLE2);  % <-- element-wise multiplication
