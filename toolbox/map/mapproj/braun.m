function [out1,out2,savepts] = braun(mstruct,in1,in2,object,direction,savepts)

%BRAUN  Braun Perspective Cylindrical Projection
%
%  This is a perspective projection from a point on the Equator
%  opposite a given meridian onto a cylinder secant at standard
...
%
%  This projection was first described by Braun in 1867.  It is less
%  well known than the specific forms of it called the Gall
%  Stereographic and the Bolshoi Sovietskii Atlas Mira projections.
%
...
%  Projection transformation
	 ...
	 x = geoid(1) * cos(parallels(1)) * long;
     y = geoid(1) * 2 * tan(lat/2);
