...
% 
% 'modal'    : Modal 正準型です。ここで、システムの固有値は、対角上に現
%              れます。システム行列 A は、対角化可能でなければいけません。
% 
% 'companion': Companion 正準型です。ここで、特性多項式がCompanion行列
%              の右端の列に現れます。
%
...
% モデルであるときのみ有効です。
%
% modal 型は、システムのモードに対する相対的な可制御性を決定する場合に
% 有効です。
