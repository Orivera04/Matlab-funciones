/* $Revision: 1.3 $ $Date: 2003/01/22 20:18:20 $ */
/* intcheckqua.c - xPC Target, non-inlined S-function driver for serial
...
#define         S_FUNCTION_NAME         intcheckqua
...
#define INT_ARG                 ssGetSFcnParam(S,1)
...
static void mdlStart(SimStruct *S)
{
    ...
    int intnum = (int)mxGetPr(INT_ARG)[0];
    ...
    if( intnum != pciinfo.InterruptLine )
    {
        sprintf( msg, "Expected IRQ %d, found IRQ %d.", intnum, pciinfo.InterruptLine );
        ssSetErrorStatus( S, msg );
        return;
    }
#endif
