...
%
%   Outputs:
%     TreeMat : [NSTATES by NTIMES] Converted matrix of Short Rate or Clean
%     Price values at points on the tree.  Time layers are columns containing
%     the different states. Unused entries of the matrix are screened with NaN's.
%      
%     TreeTimes: [1 by NTIMES] Vector of times corresponding to layers of
%     TreeMat. 
% 
...
%   $Revision: 1.8 $   $Date: 2002/04/14 21:58:14 $ 
