...
%   $Revision: 1.1.6.4 $  $Date: 2004/04/12 23:36:50 $
...
if (diffcomp~=0)
    error('rf:rfckt:lcbandstoptee:checkproperty:InvalidLC', ['To create an LC Bandstop '...
...
if (numel(l) < 3) 
    error('rf:rfckt:lcbandstoptee:checkproperty:MinimumL',['A minimum of three inductive '...
        'elements is required to create \nan LC Bandstop Tee network.']);
end
