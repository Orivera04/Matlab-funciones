function varargout = commblkdemap(block, varargin)
% COMMBLKDEMAP Mask dynamic dialog function for data de-mapping block

% Author: Trefor Delve
% Copyright 1996-2002 The MathWorks, Inc.
% $Date: 2003/01/26 18:44:30 $ $Revision: 1.1.6.1 $
...
if(strcmp(action,'default'))
   ...
   set_param(block,'MaskCallbacks',Cb,'MaskEnables',En,'MaskVisibilities',Vis);
	...
	Vals{MapVecField}= '[0 1 3 2 6 7 5 4]';
