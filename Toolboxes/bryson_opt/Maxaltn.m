function [f1,f2]=maxaltn(u,s,t,flg)
% Subroutine for Pb 3.6.25n; max hf for 727 for specified (Vf,psf);
...
ps=s(3); h=s(4); x=s(5); y=s(6); sg=u; al=11.8*pi/180;
...
elseif flg==3,
 ...
 f2=[-th*sa-cda*V^2 cs*(th*ca/V+cla*V) ...
