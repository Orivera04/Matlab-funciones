...
% $Revision: 1.1.6.5 $ $Date: 2004/04/11 00:42:35 $
...
for ct = 1:length(new_Ports)
  hData = [ hData ; ParameterEstimator.FrequencyData( new_Ports{ct} ) ];
end
...
for ct = 1:length(new_Ports)
  ...
  hData = [ hData ; ParameterEstimator.FrequencyData( new_Ports{ct}, PortNo ) ];
end
