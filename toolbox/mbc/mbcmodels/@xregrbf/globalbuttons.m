...
%   $Revision: 1.6.2.2 $  $Date: 2004/02/09 07:54:46 $
...
case 'toolbar'
   ...
   [null, hands] = xregtoolbar(xregTB, {'uipush';'uipush';'uipush'},...
      {'imageFile'}, {'refresh.bmp';'viewCenters.bmp';'pruneCube.bmp'},...
      {'Tooltipstring'}, {'Update Model Fit';'View Centers';'Prune'},...
      {'clickedcallback'}, {@i_refit;[View.mfile,'(''Subfigure'',''viewcenters'')'];[View.mfile,'(''Subfigure'',''prune'')']},...
...
case 'utilities'
   ...
   Labels = {'&Update Model Fit';'&View Centers';'&Prune'};
   CallBacks = {@i_refit;[View.mfile,'(''Subfigure'',''viewcenters'')'];[View.mfile,'(''Subfigure'',''prune'')']};
