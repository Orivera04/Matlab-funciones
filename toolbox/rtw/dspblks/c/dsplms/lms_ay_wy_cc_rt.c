/**********************/  
/* 
 * lms_ay_wy_cc_rt.c - Signal Processing Blockset LMS adaptive filter run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.1.6.1 $Date: 2003/12/06 15:57:11 $ 
 */  
#include "dsp_rt.h" 
#include "dsplms_rt.h" 


EXPORT_FCN   void MWDSP_lms_ay_wy_CC(   const creal32_T *inSigU, 
