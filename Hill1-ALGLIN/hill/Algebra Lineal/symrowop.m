...
%                      symsizeh, symelemh, & findcomh from D. Hill.
%
...
makecont=[makecont '''normal'',''pos'',[.7 .05 .1 .06],'];
...
dointchg='oldA=A;E=symelemh(m,1,rowi,rowj);A=symmul(E,A);a=A;';
...
%Do row multiple
dormult='oldA=A;E=symelemh(m,2,rowi,rowi,kval);A=symmul(E,A);a=A;';
...
dorcomb='oldA=A;E=symelemh(m,3,rowi,rowj,kval);A=symmul(E,A);a=A;';
...
done = 'close(gcf),clc,disp(''SYMROWOP is over!'')';
...
%screen title
text(-.15,1.05,'<SYMROWOP>','color','magenta','fontsize',24,...
    'fontweight','bold','erasemode','none')
...
%
warnhndl=text(-.15,.2,s4,'color','blue','fontsize',12,...
               'fontweight','bold','erasemode','none');
...
rinti=uicontrol('Style','edit','units','normal',...
        'position',etextpos(1,:),'back',bkgray1,...
       'call', ['eval(cbirowi)']);
rintj=uicontrol('Style','edit','units','normal',...
        'position',etextpos(2,:),'back',bkgray1,...
       'call', ['eval(cbirowj)']);
%
%MUTIPLY A ROW
%
...
rmultk=uicontrol('Style','edit','units','normal',...
        'position',etextpos(3,:),'back',bkgray1,...
       'call', 'eval(cbrmultk)');
rmulti=uicontrol('Style','edit','units','normal',...
        'position',etextpos(4,:),'back',bkgray1,...
       'call', 'eval(cbrmulti)');
%
...
rcombk=uicontrol('Style','edit','units','normal',...
        'position',etextpos(5,:),'back',bkgray1,...
       'call', 'eval(cbrcombk)');
rcombi=uicontrol('Style','edit','units','normal',...
        'position',etextpos(6,:),'back',bkgray1,...
       'call', 'eval(cbrcombi)');
rcombj=uicontrol('Style','edit','units','normal',...
        'position',etextpos(7,:),'back',bkgray1,...
       'call', 'eval(cbrcombj)');
%
...
rstarth = uicontrol('style','push','units','normal','pos',[.9 .13 .08 .06], ...
        'string','Restart','call','close(gcf),symrowop');
