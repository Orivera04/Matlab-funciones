function [pd,msg] = genplotdata(h,w,s)
...
%   $Revision: 1.4 $  $Date: 2002/04/15 01:17:38 $
...
if ~any(size(w)==1),
    msg = 'The frequency input argument W must be a vector.';
   return;   
end
pd.w = w(:);
