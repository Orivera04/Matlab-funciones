/**********************/  
/* 
 * lmsn_an_wy_rr_rt.c - Signal Processing Blockset Normalized LMS adaptive filter run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.1.6.1 $Date: 2003/12/06 15:57:26 $ 
 */  
#include "dsp_rt.h"
#include "dsplms_rt.h" 

EXPORT_FCN   void MWDSP_lmsn_an_wy_RR(   const real32_T *inSigU, 
