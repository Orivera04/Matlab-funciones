function [device, pciBus, pciSlot, maskDisplay, maskDescription, reset, initValue] = mdiocontecadx(phase, channel, sampletime, slot, reset, initValue)
    ...
    switch maskType(3:length(maskType))
        case 'contecad12-16'
            device = 1;
...
%   $Revision: 1.2 $  $Date: 2002/06/06 15:56:31 $
