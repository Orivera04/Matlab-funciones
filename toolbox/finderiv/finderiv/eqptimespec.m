function EQPTimeSpec = eqptimespec(varargin)
%EQPTIMESPEC Specify time structure for an Equal Probability Tree.
%
...
%
% Output:
%   TimeSpec - Structure specifying the time layout for an equal probability tree.  
%
% Example:
...
%   $Revision: 1.1.6.1 $  $Date: 2003/08/29 04:46:33 $
...
if nargin<3 
    error('finderiv:eqptimespec:InvalidInputs','ValuationDate, Maturity, and NumPeriods are required input arguments.') 
end


EQPTimeSpec = bintimespec(varargin{:});
