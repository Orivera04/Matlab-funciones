...
%    $Revision: 1.10.2.4 $  $Date: 2003/08/29 04:40:32 $

error('daq:putdata:invalidtype','Wrong object type passed to PUTDATA.  Use the object''s parent.');
