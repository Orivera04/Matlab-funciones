;;
;; C166/ST10 startup code generated by EDE for project pc167csv80flash
;;
...
$STDNAMES(reg167cs.def)		; define SFRs
...
__CSTART	PROC TASK __CSTART_TASK INTNO __CSTART_INUM = 0
	...
	BFLDH	BUSCON0, #0xDF, #(0x04AF>>8)&0xFF
	BFLDL	BUSCON1, #0xFF, #0x04AF&0xFF
	BFLDH	BUSCON1, #0xDF, #(0x04AF>>8)&0xFF
