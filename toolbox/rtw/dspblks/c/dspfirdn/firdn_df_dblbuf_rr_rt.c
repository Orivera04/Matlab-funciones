/*
 *  firdn_df_dblbuf_rr_rt.c - FIR Decimation block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.3 $  $Date: 2004/04/12 23:45:01 $
 *
...
EXPORT_FCN void MWDSP_FIRDn_DF_DblBuf_RR(
    const real32_T    *u,
          real32_T    *yout,
          real32_T    *tap0,
          real32_T    *sums,
