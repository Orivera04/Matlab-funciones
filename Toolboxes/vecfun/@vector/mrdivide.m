...
%   V/W is the elementwise right division of W into V,
%   where V and W are vector functions.
%
%   See also MLDIVIDE
...
findAx=any(Anamex=='+') | any(Anamex=='-') | any(Anamex=='*');
findAy=any(Anamey=='+') | any(Anamey=='-') | any(Anamey=='*');
findAz=any(Anamez=='+') | any(Anamez=='-') | any(Anamez=='*');
findBx=any(Bnamex=='+') | any(Bnamex=='-') | any(Bnamex=='*');
findBy=any(Bnamey=='+') | any(Bnamey=='-') | any(Bnamey=='*');
findBz=any(Bnamez=='+') | any(Bnamez=='-') | any(Bnamez=='*');
if findAx & findBx
   C.fx=['(' Anamex ')/(' Bnamex ')'];
