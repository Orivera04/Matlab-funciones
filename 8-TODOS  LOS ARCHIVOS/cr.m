function [x,res_norm,iter,flag,hist]=cr(A,b,tol,max_it,x,varargin);

% cr.m solves the linear system Ax=b using the
% CR Method without preconditioning.
%
% input   A        REAL SPD matrix
