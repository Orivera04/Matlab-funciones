/*
 * ifft_dbllen_trig_z_zbr_oop_rt.c- Signal Processing Blockset FFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.6.2.3 $  $Date: 2004/04/12 23:44:16 $
 */
 ...
 *
 */
EXPORT_FCN void MWDSP_Ifft_DblLen_TRIG_Z_Zbr_Oop(
    creal_T       *y,
    const creal_T *x,
    const int_T    fftLen
    )
...
/* [EOF] ifft_dbllen_trig_z_zbr_oop_rt.c */
