/*
 * ifft_addcssignals_d_zbr_oop_rt.c - Signal Processing Blockset IFFT run-time library components.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.5.2.3 $  $Date: 2004/04/12 23:43:57 $
 */
 ...
 * 
 */
EXPORT_FCN void MWDSP_Ifft_AddCSSignals_D_Zbr_Oop(
    creal_T *y,
    const real_T *u,
    const int_T   nChans,
    const int_T   nRows
...
/* [EOF] ifft_addcssignals_d_zbr_oop_rt.c */
