...
% $Revision: 1.1.6.4 $ $Date: 2004/04/11 00:37:51 $

% Get handles of associated packages and classes
hCreateInPackage = findpackage('ParameterEstimatorData');

% Construct class
c = schema.class(hCreateInPackage, 'SteadyStateExperiment');

% Proxy to ParameterEstimator.SteadyStateExperiment properties
