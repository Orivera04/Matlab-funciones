%Ecuación de una recta dado un vector normal a la recta y un punto de ella.
%La ecuación tiene la forma: A(x.xo) + B(y-yo) = 0, con n=[A,B], P=(xo,yo)
...
disp('La ecuación punto-normal de la recta es:');
