/*
 *  vfdly_fir_d_rt Run-time function for Variable Fractional Delay block.
 *
 *  This function implements the case of FIR interpolation mode, 
 *  Date-type is :- double-precision, real. 
 * 
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.3.2.2 $  $Date: 2004/04/12 23:49:40 $
 *
 *  
 */
...
EXPORT_FCN void MWDSP_Vfdly_FIR_D(
     ...
     const real_T         frac)
{
    const real_T *in_curr = buffptr;     /* Store new input samples: */
