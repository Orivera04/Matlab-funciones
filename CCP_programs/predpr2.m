%  predpr2.m
% Matlab file for Part 2 of the Preditor-Prey Models module
...
disp('  ')    
    ...
    disp('part 3 of this module, type: predpr3')
    disp(' ')