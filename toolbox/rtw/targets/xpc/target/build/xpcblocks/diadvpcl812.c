/* $Revision: 1.3 $ $Date: 2002/03/25 04:00:50 $ */
/* diadvpcl812.c - xPC Target, non-inlined S-function driver for digital input section of Advantech PCL-812 series boards  */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#define 	S_FUNCTION_LEVEL 	2
#undef 		S_FUNCTION_NAME
#define 	S_FUNCTION_NAME 	diadvpcl812
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    tempPortData = (rl32eInpB(din_high)<<8)|(rl32eInpB(din_low)&0xff);
