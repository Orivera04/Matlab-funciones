...
%   $Revision: 2.30.4.5 $  $Date: 2004/04/01 16:23:39 $
...
E = J*Rinv;
if (ud.obsflag)
   deltay = sqrt(sum((E.*E)')' + 1)*crit;  % predict new observation
else
   deltay = sqrt(sum((E.*E)')')*crit;      % estimate regression function
end
...
uihandles.popup     = uicontrol(nlin_fig,'String', 'Export ...',...
