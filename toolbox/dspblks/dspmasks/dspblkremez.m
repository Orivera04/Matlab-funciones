function varargout = dspblkremez(action, varargin)
% DSPBLKREMEZ Mask dynamic dialog function for Remez FIR filter block

% Copyright 1995-2002 The MathWorks, Inc.
% $Date: 2002/04/14 20:55:11 $ $Revision: 1.11 $
