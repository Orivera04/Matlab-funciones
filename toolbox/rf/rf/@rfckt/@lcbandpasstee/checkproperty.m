...
%   $Revision: 1.1.6.4 $  $Date: 2004/04/12 23:36:42 $
...
if (diffcomp~=0)
    error('rf:rfckt:lcbandpasstee:checkproperty:InvalidLC', ['To create an LC Bandpass '...
...
if (numel(l) < 3) 
    error('rf:rfckt:lcbandpasstee:checkproperty:MinimumL',['A minimum of three inductive '...
        'elements is required to create \nan LC Bandpass Tee network.']);
end
