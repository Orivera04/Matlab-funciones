echo on; clc;
%---------------------------------------------------------------------------
%A9_6   MATLAB script file for implementing Algorithm 9.6
%
...
% - - - - - - - - - - - - - - - - - - - - - - - - -
%
% Example for figure 9.13(a), page 470.  
% Use the Adams-Bashforth-Moulton method
...
diary off, echo on
pause % Press any key to perform the Adams-Bashforth-Moulton method.
...
xlabel('t');
ylabel('y');
Mx1 = 'An unstable Adams-Bashforth-Moulton solution to y` = f(t,y).';
title(Mx1);
grid;
hold off;
figure(gcf); pause % Press any key to continue.
