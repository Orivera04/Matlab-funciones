...
%   own, entirely distinct, color scale. In these cases, unlike MATLAB's
%   built-in COLORBAR function, COLORSCALE can limit the displayed colors
%   to the appropriate interval within the figure's colormap.
%
