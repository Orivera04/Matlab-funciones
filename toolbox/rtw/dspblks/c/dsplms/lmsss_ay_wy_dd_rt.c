/**********************/  
/* 
 * lmsss_ay_wy_dd_rt.c - Signal Processing Blockset Sign-Sign LMS adaptive filter run-time function 
 * 
 * Specifications: 
 * 
 ...
 *  $Revision: 1.1.6.1 $Date: 2003/12/06 15:58:03 $ 
 */  
#include "dsp_rt.h"
#include "dsplms_rt.h" 

EXPORT_FCN   void MWDSP_lmsss_ay_wy_DD(   const real_T *inSigU, 
                                const real_T *deSigU, 
                                const real_T  muU,
