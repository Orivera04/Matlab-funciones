...
%   $Revision: 1.2.2.2 $  $Date: 2004/02/09 07:14:53 $

% CGNORMFUNCTION/ISCURRENTBPDISPLAY :: tells us whether this table is currently being properly displayed 
...
if ~isequal(ud.DisplayFlags.PaneVisibility(1:2),[1;0])
