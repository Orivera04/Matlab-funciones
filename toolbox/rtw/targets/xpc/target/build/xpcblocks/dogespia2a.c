/* $Revision: 1.5 $ $Date: 2002/03/25 04:07:35 $ */
/* dogespia2a.c - xPC Target, non-inlined S-function driver for digital output section of Gespac GESPIA-2A board */
/* Copyright 1996-2002 The MathWorks, Inc.
*/

#undef S_FUNCTION_NAME
#define S_FUNCTION_NAME dogespia2a
...
static void mdlInitializeConditions(real_T *x0, SimStruct *S)
{
	...
	rl32eOutpB((unsigned short)(base_addr+2*0x0+1),0xff);			// PIA 0 A direction
	...
	rl32eOutpB((unsigned short)(base_addr+2*0x1+1),0xff);			// PIA 0 B direction
	...
	rl32eOutpB((unsigned short)(base_addr+2*0x4+1),0xff);			// PIA 1 A direction
	...
	rl32eOutpB((unsigned short)(base_addr+2*0x5+1),0xff);			// PIA 1 B direction
...
static void mdlOutputs(real_T *y, const real_T *x, const real_T *u, SimStruct *S, int_T tid)
{
        ...
        rl32eOutpB((unsigned short)(base_addr+2*port+1),(unsigned short)output);
...
{   
        ...
        rl32eOutpB((unsigned short)(base_addr+2*port+1),0x0);
