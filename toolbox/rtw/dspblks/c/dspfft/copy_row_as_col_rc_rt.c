/*
 * copy_row_as_col_rc_rt.c - Signal Processing Blockset run-time library.
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.1.6.1 $  $Date: 2003/12/06 15:55:21 $
 */
 ...
 */
EXPORT_FCN void MWDSP_CopyRowAsCol_RC(
    creal32_T          *y,
    const real32_T     *x,
    const int_T       nCols,
    const int_T       nRows,
