% $Revision: 1.1 $
========================================================================
		ActiveX Control DLL : MWSAMP2
========================================================================

ControlWizard has created this project for your MWSAMP2 ActiveX Control
...
that make up your MWSAMP2 ActiveX Control DLL.
...
Mwsamp2Ctl.h
	This file contains the declaration of the CMwsamp2Ctrl C++ class.

Mwsamp2Ctl.cpp
	This file contains the implementation of the CMwsamp2Ctrl C++ class.

Mwsamp2Ppg.h
	This file contains the declaration of the CMwsamp2PropPage C++ class.

Mwsamp2Ppg.cpp
	This file contains the implementation of the CMwsamp2PropPage C++ class.

Mwsamp2Ctl.bmp
	This file contains a bitmap that a container will use to represent the
	CMwsamp2Ctrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file mwsamp2.rc.
