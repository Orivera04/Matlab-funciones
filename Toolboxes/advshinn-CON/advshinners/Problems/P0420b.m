function [ret,x0,str]=P0420B(t,x,u,flag);
%P0420B is the M-file description of the SIMULINK system named P0420B.
%       The block-diagram can be displayed by typing: P0420B.
%
%       SYS=P0420B(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%       Setting FLAG=1 causes P0420B to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%       Calling P0420B with a FLAG of zero:
%       [SIZES]=P0420B([],[],[],0),  returns a vector, SIZES, which
