/*
 *  poly2lsfr_r_rt.c - Poly2Lsf block runtime helper function
 *
 *  Copyright 1995-2003 The MathWorks, Inc.
 *  $Revision: 1.2.2.2 $  $Date: 2004/04/12 23:47:31 $
 */

#include "dsppoly2lsp_rt.h"

EXPORT_FCN int_T MWDSP_Poly2Lsfr_R(
...
{
    int_T nf    = MWDSP_Poly2Lsp_R(lsp,G1,G2,NSteps,NBisects,M1,M2,bptr);
    int_T i;
    for (i = 0; i < P; i++) {
        lsp[i] = (real32_T)acos((real_T)lsp[i]);
    }
    return(nf);
}

/* [EOF] poly2lsfr_r_rt.c */
