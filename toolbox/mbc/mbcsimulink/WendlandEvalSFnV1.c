...
#define S_FUNCTION_NAME  WendlandEvalSFnV1
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Parameter containing the order of the polynomial */
    ...
    ssSetInputPortWidth(S, 0, (int)*mxGetPr(ssGetSFcnParam(S,0)));
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	int lenP = ssGetInputPortWidth(S,0);
	int lenX = ssGetInputPortWidth(S,1);
