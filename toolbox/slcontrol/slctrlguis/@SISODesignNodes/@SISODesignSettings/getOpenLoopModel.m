function [sys,J] = getOpenLoopModel(this,opcond,Blocks);
...
%%          dx = Ax + B [w; u]
%%     [y; z]  = Cx + D [w; u]
[sys,J] = linearize(opcond.Model,opcond,[oldio;hin;hout]);

%% Reset the old Analysis I/O settings
setlinio(opcond.Model,oldio);
