function [ret,x0,str,ts,xts]=chapt6(t,x,u,flag);
%CHAPT6	is the M-file description of the SIMULINK system named CHAPT6.
%	The block-diagram can be displayed by typing: CHAPT6.
%
%	SYS=CHAPT6(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes CHAPT6 to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling CHAPT6 with a FLAG of zero:
%	[SIZES]=CHAPT6([],[],[],0),  returns a vector, SIZES, which
...
simver(1.3)
if (0 == (nargin + nargout))
     set_param(sys,'Location',[100,100,779,575])
     open_system(sys)
end;
