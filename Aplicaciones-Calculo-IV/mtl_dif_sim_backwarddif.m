%% Backward Divided Difference Worksheet for First Derivative
function Backward
clc
clear all
...
%% Enter the inputs
% This is the only place in the program where the user makes changes to the data function f(x)
...
disp(sprintf('\nThis worksheet demonstrates the use of Matlab to illustrate Backward '))
disp(sprintf('Difference Approximation of the first derivative of continuous functions.')) 
disp(sprintf('Backward Difference Approximation of the first derivative uses a point h'))
disp(sprintf('behind of the given value of x at which the derivative of f(x) is to be\nfound.'))

disp(sprintf('\n\n************************** Section 1: Input ****************************'))
format short g
disp(sprintf('\nThe following simulation approximates the first derivative of a')) 
disp(sprintf('function using Backward Difference Approximation. \n\nThe user inputs are'))
...
disp(sprintf('Av: Approximate value of the first derivative using Backward Difference \nApproximation'))
...
title({'Approximate Solution of the First Derivative using'; 'Backward Difference Approximation as a Function of Step Size'})
...
disp(sprintf('\nUse Backward Divided Difference method with a step size of 0.25 to find')) 
disp(sprintf('the acceleration at t=5s. Compare with the exact answer and study the effect\nof the step size.'))
...
disp(sprintf('\nTo obtain more accurate values of the first derivative using Backward '))
disp(sprintf('Difference Approximation, the step size needs to be small. As the '))
disp(sprintf('spreadsheet shows, the smaller the step size value is, the approximation'))
disp(sprintf('is closest to the exact value. However, too small a step size can result'))
disp(sprintf('in noticeable round-off errors, and hence giving highly inaccurate results.'))
